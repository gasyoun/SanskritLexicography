...
| [progress_dashboard/](https://github.com/gasyoun/SanskritLexicography/tree/master/progress_dashboard) | Public **web kitchen** for PWG→RU ([live `/progress/`](https://gasyoun.github.io/SanskritLexicography/progress/)) — progress + speed/cost/idle/calendar/changelog; browser poll **60 s**. Twin: local ops at `127.0.0.1:8765` (**5 s**, not published). See [progress_dashboard/README](https://github.com/gasyoun/SanskritLexicography/blob/master/progress_dashboard/README.md) · [RU deep manual §2d](https://github.com/gasyoun/SanskritLexicography/blob/master/docs/manuals/RUSSIANTRANSLATION_DEEP_MANUAL.md). |
