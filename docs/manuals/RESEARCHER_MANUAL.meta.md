...
The manual quotes no runnable commands; every count and citation was verified read-only against the tree (union / PWG-layer / particle / literature figures all reproduced by the fact-check agent).
...
| 2 | After the FINDINGS §80/§86/§87 renumber repair, simplify the §5 citation caveat | open |
