...
| Local ops dashboard | Task `SL progress dashboard server` → `http://127.0.0.1:8765/` (5 s), **localhost only**, logon-only policy. Manual fallback: `python RussianTranslation/src/pilot/dashboard_server.py`. — [windows/README](https://github.com/gasyoun/SanskritLexicography/blob/master/progress_dashboard/windows/README.md) | Active | maintainer |
