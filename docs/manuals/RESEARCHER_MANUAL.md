...
| Headword union | 323,422 headwords across 15 csl-orig dicts with per-dict provenance + gender; feminines folded | [HeadwordLists/union/UNION.md](https://github.com/gasyoun/SanskritLexicography/blob/master/HeadwordLists/union/UNION.md) |
