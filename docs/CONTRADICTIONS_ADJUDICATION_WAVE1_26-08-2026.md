...
| §10 | Merged-TSV line count 323,422 vs headword count 323,422 | Tier 1 | **✅ RULED — both true under different scopes**; line 1 is the header row (`slp1 · iast · n_dicts · dicts · gender · fem_fold`), data rows = 323,422 = headword count of record |
