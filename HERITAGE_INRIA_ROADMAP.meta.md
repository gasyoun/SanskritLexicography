...
_Created: 18-07-2026 · Last updated: 23-08-2026_
...
| 2 | ~~Phase 6 — segmenter-as-service cross-validation vs DharmaMitra GPU morphology~~ | — | ✅ **done 23-08-2026** (H3171, OxAlpha `x-preview-f-free`) — [heritage_phase6_crossval.md](https://github.com/gasyoun/SanskritLexicography/blob/master/RussianTranslation/gold/heritage_phase6_crossval.md); all six phases now ✅ |
...
## Deprecation status
`active` — truth-passed 19-08-2026 (H3001); **all six phases done** after phase 6
executed 23-08-2026 (H3171). Per the sunset plan the subject is now a fully-executed
historical record of the integration (retitle rather than delete — the LGPLLR×BY-SA
ruling stays citable). Note that the **subject document's body was accurate throughout**
until the 19-08-2026 truth-pass — this metadoc was the stale surface, which is the inverse
of the usual failure and worth remembering when auditing this estate.
...
| 23-08-2026 | Phase 6 executed — backlog row 2 closed, sunset condition reached | OxAlpha (`x-preview-f-free`), H3171 |
