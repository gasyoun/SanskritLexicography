...
### Root Level (4 files)
Core reference works on Sanskrit composition and syntax:
- **Apte-Composition1885.md** - V.S. Apte's Sanskrit composition manual (1885)
- **Leitan_Sintaksis 20.2_11.09.2022.md** - Russian syntax analysis study
...
- **Source:** Original filename (with path)
- **Type:** File format (PDF, EPUB, DOC, DOCX, etc.)
