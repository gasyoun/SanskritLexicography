...
- [ ] **FAIR sprint (G1, G3, G6)**: Zenodo DOI for atlas data release v1; CITATION.cff in csl-atlas, csl-standards, VisualDCS, csl-observatory; ORCID registered and added to papers; PROV-O crosswalk page for evidence labels; per-dataset licence fields. **Partial (re-probed 24-09-2026):** `CITATION.cff` exists in all four repos ([atlas](https://github.com/sanskrit-lexicon/csl-atlas/blob/main/CITATION.cff) · [standards](https://github.com/sanskrit-lexicon/csl-standards/blob/main/CITATION.cff) · [VisualDCS](https://github.com/gasyoun/VisualDCS/blob/main/CITATION.cff) · [observatory](https://github.com/sanskrit-lexicon/csl-observatory/blob/main/CITATION.cff)) but `.zenodo.json` only in atlas + observatory — none was ever committed in standards/VisualDCS; ORCID sparse (atlas 2, VisualDCS 1, observatory 1, standards 0); atlas README's [Pending-author-actions note](https://github.com/sanskrit-lexicon/csl-atlas#readme) still stands — no Zenodo connection, no atlas DOI (first org-side DOI is A12's dataset [10.5281/zenodo.21346705](https://doi.org/10.5281/zenodo.21346705), minted 16-08-2026); the G3 PROV-O crosswalk now exists in draft (see G3); per-dataset licence fields present in 18/175 atlas data JSONs (e.g. [etymology-oracle.json](https://github.com/sanskrit-lexicon/csl-atlas/blob/main/data/etymology-oracle.json)) — a full licence census is still owed.
...
1. **Learner's layer v2 + user study (G7)**: task-based evaluation with the review-pool students (find-the-right-sense tasks, timed, vs plain Cologne lookup); results feed P6. *(Status 24-09-2026: user study not found; layer v1 exists on origin/main (see Q4) — v2 n/a.)*
