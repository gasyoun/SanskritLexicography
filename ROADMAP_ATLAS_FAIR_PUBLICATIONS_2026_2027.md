...
- **Definition typology**: synonym gloss vs equivalent vs encyclopedic description per dictionary — the single most classical microstructural dimension. **◐ first-pass 24-07-2026 (H1483):** operational rubric + 15-dict / 926k-record distribution + gold sample 62% — [DEFINITION_TYPOLOGY_WS2_4_2026.md](https://github.com/gasyoun/SanskritLexicography/blob/master/data/DEFINITION_TYPOLOGY_WS2_4_2026.md). Double-keyed 300×7 pool still open (item 6 below).
