...
3. **P4 drafted** (indigenous microstructure); decide IJL vs WSC 2027 by deadline calendar. *(Status 24-09-2026: drafted ×2, NOT submitted — [A04](https://github.com/gasyoun/Uprava/blob/main/ARTICLES.md) 4/5 (verbal-root kośa) + [A30](https://github.com/gasyoun/Uprava/blob/main/ARTICLES.md) 3/5 (ŚKD/VCP), both author-passed 06-09-2026, awaiting MG read-and-sign; IJL-vs-WSC venue `@DECIDE` open.)*
