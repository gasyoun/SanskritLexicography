...
3. **P6 submitted** (learner's layer + study). *(Status 24-09-2026: not found — [ARTICLES.md A32](https://github.com/gasyoun/Uprava/blob/main/ARTICLES.md) is 1/5, idea only, no artifact of its own.)*
