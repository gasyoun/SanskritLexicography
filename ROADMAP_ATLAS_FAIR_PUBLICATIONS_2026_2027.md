...
4. **Book writing begins** against the contract; new chapters 1, 2, 7, 10 drafted (everything else is revision of P1–P6). *(Status 24-09-2026: not started — correctly gated on the contract; the proposal draft exists (see Q4).)*
