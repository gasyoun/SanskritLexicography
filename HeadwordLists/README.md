...
headword index across the 8 key1 dicts (**295,298** headwords with per-dict provenance + gender),
feminines folded under the masculine (`mf(ā/ī)`); built by [`build_union.py`](build_union.py).
