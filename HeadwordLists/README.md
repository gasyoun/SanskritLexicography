...
**Typo queue (item A):** [`A_TYPO_QUEUE.md`](A_TYPO_QUEUE.md) — **all 122** body-confirmed
...
[`assemble_typo_queue.py`](assemble_typo_queue.py); verify on scan, then file.

**Coverage additions (item B):** [`COVERAGE_ADDITIONS.md`](COVERAGE_ADDITIONS.md) — DCS-corpus
lemmas absent from all CDSL dicts, ranked by band ([`coverage_additions.py`](coverage_additions.py)),
