...
def main():
    ...
    md += ["", "## Files", "",
           "- [`union/union_headwords.tsv`](union_headwords.tsv) — the merged list "
           "(`slp1, iast, n_dicts, dicts, gender, fem_fold`); folded feminines removed, their "
           "masculine carries the `mf(ā/ī)` marker.",
           "- [`union/folded_feminines.tsv`](folded_feminines.tsv) — audit of every "
           "auto-fold (`-inī`→`-in`).",
           "- [`union/fold_candidates.tsv`](fold_candidates.tsv) — `-ā`/`-ī` feminines to "
           ...
           "- [`union/low_candidates_screened.tsv`](low_candidates_screened.tsv) — the "
