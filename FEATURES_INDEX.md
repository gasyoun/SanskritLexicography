...
| G3 | [kosha — translator-first dictionary](https://github.com/gasyoun/kosha) | Multi-dict collapse (MW+PWG+AP90), scan-anchored crawlable `/w/{slp1}` (SSR + D4 static head N=11,148 / 10,370 pages, H1590); SPA twin; exit packet for live deploy checks | 🟡 Beta | collapse MW + PWG + AP90 for one headword; open a headword word page | 07/26 | FastAPI · SQLite · static HTML · [kosha](https://github.com/gasyoun/kosha) · [exit packet](https://github.com/gasyoun/kosha/blob/main/docs/P5_WORD_PAGE_EXIT_PACKET.md) |
