...
_Created: 04-07-2026 · Last updated: 02-09-2026 (H3878: E25 refreshed — the aorist/perfect conflation it warned about was resolved inside the indicative by H1486, and the residual 8,726 non-indicative past tokens are unformationed upstream, not query-hidden; prior: H3790: E53 curated per-work dating table for PWG's 45 cited works — sourced ranges, two dating-invalid sigla, eleven decisions on the vote hub; prior: H3750: L15 pwg_ru provenance census — measured/asserted/absent classifier + the git-reconstruction probe that refuses the backfill; H3344: crosslink audit — P4 `public/exercises` repointed to its renamed `public/lila`; H2943: P12 samskrtam.ru crossword + bandha explorers; H2874: F47 citation-count provenance resolved + the two `<ls>` count tables added as sidecars; H2408: F48 defgen eval benchmark + D20 corrected French/second-reference role; H2361: L12 citation_tm.py parallel-verse lookup + its measured EN-lane misalignment; H2110: H8 Systema in-cabinet reading packs; H1909: L5 nws_ls_markup.py bare-citation discriminator)_
...
**At a glance:** 44 dictionaries · 23 interfaces (17 live) · 47 data assets · 15 tools · 4 external stacks · 12 learner-facing drill/practice sets (P1–P12) · 30 catalogued methods/algorithms (Q1–Q30).
