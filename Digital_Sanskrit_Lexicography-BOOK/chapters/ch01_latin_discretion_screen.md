# Chapter 1 — The Latin Discretion-Screen: How the European Dictionaries Self-Censored

_Created: 13-07-2026 · Last updated: 13-07-2026_

> **Provenance.** This chapter is the book-form version of the research note *The Latin
> discretion-screen in nineteenth-century Sanskrit lexicography: a history, and a
> metalanguage-relative method for measuring it* (source draft:
> [A36_latin_obscena_note.md](https://github.com/gasyoun/SanskritLexicography/blob/master/papers/A36_latin_obscena_note.md)),
> which is being submitted separately to *Beiträge zur Geschichte der Sprachwissenschaft*
> (Nodus, Münster); where the article must remain independently citable, cite that version.
> Every count, table, and figure below is carried over from the note unchanged; only the
> framing has been converted from journal to book form — the abstract and venue apparatus
> removed, the register unified to the book's, and cross-references remapped to sibling
> chapters. Section numbering is chapter-internal (§1–§7); the book-wide renumbering and
...
**layered evidence graph**, in which every lexicographic statement carries not only its
content but its stance — its source, its convention, its grade of evidence, its address to
a reader. This opening chapter takes the least computational and most human of those
stances, the one written into the very *language of the gloss*, and shows that it too is a
measurable node in the graph. When a nineteenth-century editor rendered a taboo Sanskrit
word not in his own vernacular but in Latin — Böhtlingk glossing the root √*yabh* simply
**futuere**, with no German verb at all — he encoded, in the choice of metalanguage, a
decision about who was permitted to understand him. That decision is recoverable, datable,
and countable; recovering it is the work of this chapter.

The chapter does double duty for the book. Historically, it is the origin story of the
European tradition whose entry-anatomy, sense-structure, and citation apparatus the later
chapters dissect: it shows how the Petersburg school and its heirs made, read, and
*self-censored* their dictionaries, and so opens the **two-metalanguages motif** that runs
through the whole comparative argument — the European dictionaries speak *about* Sanskrit in
a prestige screen-language (Latin), while the indigenous kośa tradition (Chapters 4, 7)
speaks Sanskrit *in* Sanskrit and has, as we will see, no outsider to screen against.
Methodologically, it introduces in miniature the discipline the next chapter states in
full: a claim about a dictionary is only as good as the confound it survives. The naïve
signal here — "count the Latin" — is confounded by the fact that Latin is also the source of
English scientific vocabulary, and the fix is a **metalanguage-relative test** that scores a
gloss against its own dictionary's register. That move — measure the *marked-ness* of a
choice, not the raw string — is the same instinct the measurement framework of Chapter 2
formalises across ten estimators.
...
the lay reader cannot. The practice is not a quirk of one editor but a shared register rule
of the St Petersburg school, taken over from Greek and Roman textual scholarship, where
*obscaena* were left untranslated or rendered into Latin in an otherwise vernacular
...
Note the candour *behind* the screen: a full sentence, *quae futui cupit* "she who longs to
be f.", is given because it is in Latin. In Sanskrit lexicography the classic case is thus
Böhtlingk–Roth's Petersburg *Wörterbuch*; the device is familiar at the margins of classical
scholarship — the Loeb Classical Library's Latin renderings of obscene Greek,
Liddell–Scott's *inire, coire* for βινέω — but it has never been documented for Sanskrit
lexicography, nor measured for any tradition. This chapter measures it.

### The historiographic and comparative frame

Three neighbouring lexicographic literatures locate the phenomenon and, in locating it,
sharpen the originality claim.

**The Greco-Roman genealogy of lexicographic decorum.** The idea that a dictionary or
commentary encodes a register hierarchy — and avoids certain matter on grounds of decorum —
is as old as Servius, whose scholia sort diction into *grandiloquus / medius / humilis* and
who declines to gloss the low or the indecent under a *lucerna propter uilitatem* logic (the
lamp too base to name); the practice of the ancient scholiast is the deep ancestor of the
editorial reticence studied here (Ferri, in Maltby et al.). The nineteenth-century Latin
screen is the same decorum-instinct, moved from the margins of a text-edition into the body
of a bilingual dictionary entry.

**The contrast case: correctness, not prudery.** The one great non-European lexicographic
tradition with a comparably explicit register-policing apparatus, the Arabic, polices
*laḥn al-ʿāmma* — the solecisms of common speech — a correctness-screen aimed at purity of
language, not at sexual taboo (Baalbaki). The comparison is instructive precisely by its
mismatch: neither the Arabic tradition nor the Latin scholiastic one has a *sexual*-taboo
screen of the Petersburg kind. **The discretion-screen documented here is Europe-specific
and high-Victorian**, which is what makes it a discovery rather than an instance of a known
type — the point the diachronic evidence of §3c drives home.
...
*fuck*, not restored until the 1972 Supplement, and no English dictionary printed *fuck*
until the Penguin (1965), under the shadow of Victorian obscenity law. The Petersburg
strategy is the **opposite** trade-off: *include* the word — scholarship demands
completeness — but *screen* it in Latin. The two solutions, omit versus encrypt, are the
genre's two answers to the same pressure, and the Latin screen is the one that let a
dictionary be both complete and "decent". The device does occur inside a dictionary entry in
the era's most famous lexicon — Liddell–Scott glosses βινέω "*inire, coire*, of illicit
intercourse" — but that case lives in anecdote and press coverage; it has not been treated
as an object of historiography, and it has never been counted. To my knowledge the
discretion-screen has never been documented for Sanskrit lexicography at all, and never
*measured*, corpus-wide and against controls, for any tradition.
...
record the headword (SLP1 + IAST via
...
**Two filters matter** (both guard against the plant/animal-name Latin one *expects* in
these dictionaries and which is *not* a discretion-screen):
...
prose, and *mingere* was the acceptable term — but the criterion here is not their Roman
register: it is that **no nineteenth-century vernacular author prints them except as a
screen**, which is what the tag must track. The medical/euphemistic register (*coitus,
penis, vulva, pudenda, virilia, semen, clitoris*) is tagged **CLINICAL**. The distinction is
the point of the study: only the first set is "Latin so as not to be understood" in the
strong sense; the second is the era's default scientific register, screening by side effect.
I use Adams' obscene/euphemistic split not, as Adams did, to study Latin, but as a
**diagnostic** applied to the *metalanguage* of dictionaries of another language.
...
[`A36_latin_obscena.csv`](https://github.com/gasyoun/SanskritLexicography/blob/master/papers/A36_latin_obscena.csv);
the table above is the German Petersburg core, where the convention is densest and the
vulgar set was hand-vetted.
...
> word that screens in German (*coitus, penis, faeces*) is *naturalised* in English
> scientific prose — *faeces* is even the ordinary British spelling. So the English "vulgar"
> counts above are inflated by naturalised *faeces*. The honest veil-test for an English
> dictionary is the **truly obscene Latin core** no English author would write except to
> screen — *futuere, cunnus, mentula, stercus, paedicare, mingere* — which isolates a sharp
> result:
...
The Adams tag (§2) is a property of *Latin*: it asks whether a word was obscene in Rome. But
whether a Latin word *functions as a veil* in a dictionary depends on the dictionary's
...
- **The clinical tier inverts — English uses it *more*.** *penis* (241 vs 135), *pudenda*
  ...
  choice. A high "clinical-Latin" count in English therefore measures the **English
  lexicon**, not concealment; the identical count in German measures a **decision**.
...
*semen*/*penis* tokens. This is, in the small, the discipline the next chapter generalises:
a raw count is a confound until it is scored against the register that produced it.
...
most telling datum is **within one author**: Monier-Williams's *first* edition (1872) screens
**no headword at all** — it glosses √*yabh* in plain English, "to know carnally, have sexual
intercourse with, lie with", and its single obscene-core string (*cunnus*) sits inside a
comparative etymology, glossing the Lithuanian cognate *pís-ti* in Latin (an exact miniature
of the §5a finding: the comparative reach itself hides behind Latin). His *second* edition
(1899) uses *futuere* **four** times — the screen *tightened* across the high-Victorian
quarter-century, in the same lexicographer's hands. The device is thus not "Victorian
English" or "German philology" as such but a **shared high-Victorian moment** — the label is
anglocentric shorthand for a print-decency regime that was European (the Petersburg volumes
are a Russian-imperial German product) — the half-century when a learned readership and a
strict print-decency norm co-existed. That this window is bounded on both sides, and absent
from the Greco-Roman and Arabic comparanda of §1, is what marks the screen out as a
period-specific European invention rather than a lexicographic universal.
...
Each gloss-text sample was language-typed by function-word frequency, then the obscene core
(*futuere/cunnus/mentula/stercus/cacare/paedicare/mingere*) was counted with the binomial +
denylist filters of §2.
...
- **French takes a third path.** Neither Latin obscenity nor vulgar French: Stchoupak–Nitti
  ...
  vernaculars, already close to the Latinate clinical register, euphemise *in the
  vernacular* rather than switching languages.
- **Sanskrit-medium dictionaries do not screen at all.** The Śabdakalpadruma, Vācaspatya &c.
  score zero obscene Latin (the lone *cacare* tokens are incidental): a dictionary whose
  metalanguage *is* the learned language has no lay outsider to screen against — the veil
  presupposes a vernacular/elite split that a Sanskrit-to-Sanskrit kośa lacks. This is the
  first appearance of the book's structural contrast between the two traditions (Chapters 4
  and 7): the indigenous kośa cannot self-censor by metalanguage because it has only one.
...
*because there was no German the editors were willing to print*. It clusters in three places
— the √*yabh* family (sexual act), the defecation roots and dung-nouns (scatology), and a
handful of metaphorical *cunnus* kennings.
...
e.g. *śamala* → *viṣṭhā* — which is itself telling: the editors cross-refer one veiled word
to another.)
...
- **The √*yabh* cluster** carries the whole *futuere* register: *yabh, yābha, yabhana,
  ...
  **lexicalised**, not scattered — the editors reached for *futuere* only here and in a few
  quotation contexts (*ram* "to take pleasure", *sap*, the *hata/fututa* pun under *han*).
- **The Vājasaneyi-Saṃhitā Aśvamedha litany** surfaces three times behind the screen: *gar*
  and *sakthan* (VS 23,22 and 23,29 — the ritual obscenities exchanged by the queen and the
  priests) and *maṇḍūradhāṇika* (ṚV 10,155,4), all glossed *cunnus*. This is precisely the
  material a 19th-century editor would not render into German.
- **Metaphorical kennings** are decoded *into* Latin: *madanātapatra* "Madana's parasol" and
  *manobhavāgāra* "the love-god's chamber" → *cunnus*.
- **Scatology is screened only in PWG/PW, never in SCH** (Schmidt has zero), and the same
  dictionaries print open German *Excremente* elsewhere — so here the Latin is
...
both metalanguages, taken up by editor and intended reader: the German Petersburg school uses
it as a rule, **Monier-Williams** keeps the Latin as a learned doublet beside English, and
**Cappeller** reaches for *futuere* twice — while **both Apte editions and Wilson never
...
dictionaries made for Indian students, and (see §3a) it does **not** return in the Gode–Karve
revision. That the screen bends to the *reader* — present for the European scholar, absent
for the Indian student — is the earliest instance of a theme the book returns to whenever the
dictionary's address to its user is at stake (Chapter 13, Renou's registers).
...
dictionaries for comparative-philology apparatus (the sigla *Miklosich, Curtius, Fick, Pott,
Kuhn, Benfey*; *Vgl. Gr.*; cognate-language tags *slav., lat., gr., got., lit., ahd.*),
**exactly one entry matches: PWG √*yabh***. PW's √*yabh* is terse — "*futuere* BHĀG. P." —
with no footnote; *mih, gu, viś, śakṛt, gūtha* and the rest carry none. And the rarity is
structural, not incidental: across the entire 593,596-line PWG, the same scan finds only
**seven** comparative-grammar references at all (the Petersburg *Wörterbuch* programmatically
excluded Indo-European etymology, and whatever a wider siglum list might add, the order of
magnitude — a handful in half a million lines — stands). That √*yabh* is one of those seven
is the point — the single place where Böhtlingk reached past the Sanskrit into comparative
grammar is an obscene root, and the reach is itself encrypted in Latin and a Latin-script
Slavic siglum.
...
Two fields are decisive. BOP glosses Sanskrit "prostitute" words with *meretrix* (*bandhakī,
gaṇikā, paṇyastrī, puṃścalī, veśyā*) and "violate / rape" words with *stuprum / stuprare*
(*dhṛṣ, duṣ, mṛś*). **In the German dictionaries these two fields are glossed in German,
never in Latin** — *gaṇikā* → *Hure / Buhlerin*, *duṣ* → *schänden* — and indeed the entire
German corpus has **zero** *meretrix* and **zero** *stuprum*. The screen was *not* applied
here. Why? Because German already had printable words for "whore" and "to violate"; it had no
printable word for the sexual act, the genitalia, or excrement. **The Latin screen maps
precisely onto the gaps in the decent German lexicon** — it covers *futuere / cunnus /
stercus* (where German offered only *ficken / Fotze / Scheiße*) and stops exactly where
German offered a usable euphemism. Bopp, lacking any vernacular to fall back on, Latinises
the whole field and so throws that selectivity into relief.
...
2. **Excretion — partial screen (79 %).** Here German *did* have semi-printable words, and
   ...
   field).
3. **Prostitution + sexual violence — no screen at all.** German had fully respectable
   words, so *meretrix* and *stuprum* never appear: *gaṇikā, paṇyastrī, puṃścalī* → *Hure*;
   √*duṣ* → *verderben, schänden*. Bopp must write *meretrix / stuprare* because Latin is all
   he has; the German editors, who had *Hure* and *schänden*, never reach for Latin here.
...
The editors who would not write a German word for "to copulate" or "vulva" cheerfully
printed **√*had* → *scheissen*** "to shit" (Dhātup. 23,8), **√*mih* → *seichen*** "to piss",
...
in plain (often crude) German. (Full inventory:
[`A36_blunt_german.csv`](https://github.com/gasyoun/SanskritLexicography/blob/master/papers/A36_blunt_german.csv).)

## 6. Why it matters

1. **For the historiography of the discipline.** The chapter recovers and dates a practice
   that the literature on 19th-century comparative philology and lexicography has not
   described as such: a systematic *linguistic* discretion-screen, distinct from the
   Anglophone strategy of omission (Mugglestone 2005), by which the St Petersburg school and
   its heirs kept their dictionaries simultaneously *complete* and *decent*. It locates the
   practice precisely — strongest in Böhtlingk–Roth, fading by Schmidt (1928), tightening
   within Monier-Williams's own two editions — and ties it to the same decorum-impulse that
   runs from Servius' scholia (Ferri) to Loeb's Latin-screened Greek a generation later,
   while distinguishing it sharply from the *correctness*-policing of the Arabic tradition
   (Baalbaki), which screens for purity, not modesty. For the history of Indology it also
   returns to view a stratum of the lexica (the Aśvamedha and *kāvya* obscene vocabulary)
   that the screen made invisible to non-classicists for over a century.
2. **A reusable method (the formal contribution).** The metalanguage-relative test (§3b)
   generalises beyond Sanskrit and beyond Latin: any historical dictionary whose
   discretion-screen is written in a *prestige* language that also feeds the target
   language's technical register (Latin/Greek into the European vernaculars; Classical
   Chinese; Sanskrit into the modern Indian languages) faces the same confound, and the same
   fix — score the screen against the *marked-ness* of the gloss in that dictionary's own
   metalanguage, not against a raw word list. The three controls here (screen-vs-doublet,
   blunt-vernacular counter-inventory, all-screen-language positive control) are a portable
   validation kit — and a first, concrete instance of the "measure the marked choice, not the
   raw count" discipline that Chapter 2 states in general.
3. **Coverage gap for the modern reader.** A learner consulting PWG/SCH for *yabh*,
   *cunnus*-glossed kennings, or the Aśvamedha vocabulary meets a Latin wall. Any
   evidence-graded or learner-facing layer over these dictionaries should **resolve the Latin
   screen into the target language** — the dataset here is a ready de-veiling key, and the
   language-of-the-gloss becomes one more reviewable node in the evidence graph.
...
5. **A candour axis across dictionaries.** It pairs with the book's later structural probes —
   sense inheritance and ordering (Chapter 6) and Renou's usage registers (Chapter 13): the
   *language of the gloss itself* encodes the editor's stance toward the reader, and it varies
   systematically by audience and date. The discretion-screen is, in the terms of the
   Introduction, an evidence-graph edge like any other — source-tagged, datable, gradable —
   and it is fitting that the book's first chapter should find the human decision hiding
   inside the most mechanical-looking of lexicographic facts, the choice of which language to
   gloss in.
...
- Full dataset:
  [`A36_latin_obscena.csv`](https://github.com/gasyoun/SanskritLexicography/blob/master/papers/A36_latin_obscena.csv)
  (2,104 Latin-glossed senses, eleven dictionaries, with a `lang` column for metalanguage).
  The `register` column is the raw, metalanguage-neutral Adams tag; for English dictionaries
  it should be read through the caveat below (naturalised *faeces/coitus/penis* are not veils
  there).
- Counter-inventory:
  [`A36_blunt_german.csv`](https://github.com/gasyoun/SanskritLexicography/blob/master/papers/A36_blunt_german.csv)
  (401 entries where the German dictionaries print blunt/plain German for a taboo concept),
  supporting §5b.
- Corpus-wide sweep:
  [`A36_corpus_screen.csv`](https://github.com/gasyoun/SanskritLexicography/blob/master/papers/A36_corpus_screen.csv)
  (44 rows — the 43 CDSL dictionaries with MW's two editions as separate rows — with
  metalanguage, year, raw obscene-core and clinical counts), supporting §3d.
- Extraction is a single pass over the eleven SLP1 source files with the term list,
  ...
  via [`sanskrit-util`](https://github.com/sanskrit-lexicon/sanskrit-util). The method is
  fully specified above and the CSV is the canonical artefact.
...
- **Clinical-set audit.** The clinical fields were audited for the plant/animal-binomial
  ...
  *verendet* "perished". The reported clinical counts are post-audit. The vulgar set (§4) was
  additionally vetted entry-by-entry.
...
Ferri, Rolando. 2019. "Grammarians on Poets: The Case of Servius." In Robert Maltby et al.
(eds.), *Studies on Late Antique and Medieval Latin Glossaries and Dictionaries.* [The
Greco-Roman genealogy of lexicographic decorum: Servius' *grandiloquus/medius/humilis*
register system and *lucerna propter uilitatem* decorum-avoidance.]
...
Dictionary.* New Haven and London: Yale University Press.
...
- **STC** Stchoupak, Nadine, Luigia Nitti & Louis Renou. 1932. *Dictionnaire
  sanscrit-français.* Paris: Geuthner. **BUR** Burnouf, Émile. 1866. *Dictionnaire classique
