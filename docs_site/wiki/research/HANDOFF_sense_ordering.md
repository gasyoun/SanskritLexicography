...
| PW | [`PWK/prefaces/pwpref_all.de.md`](https://github.com/sanskrit-lexicon/PWK/blob/main/prefaces/pwpref_all.de.md) | `csl-orig/v02/pw/pw.txt` |
...
| GRA | [`GRA/prefaces/grapref_all.en.md`](https://github.com/sanskrit-lexicon/GRA/blob/main/prefaces/grapref_all.en.md) (also `.de`, `.ru`) | `csl-orig/v02/gra/gra.txt` |
...
| **GRA** | **EXPLICIT — the only preface that states the rule.** Senses derived from a reconstructable **basic meaning**, then numbered for usefulness. | "I have **derived the meaning … from reconstructable basic meaning**, but then simply by consecutive numbers … put in **sequence** … so that it becomes apparent which meaning … I attribute to the word in each referenced passage." ([grapref_all.en.md L74–85](https://github.com/sanskrit-lexicon/GRA/blob/main/prefaces/grapref_all.en.md)) |
