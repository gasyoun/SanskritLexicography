...
New manifests generated by `gen_opt_harness2.py` explicitly declare
`runtime.max_output_tokens`. The plan compiler accepts only the exact model in
the source manifest (`claude-sonnet-5` or `claude-opus-5`); there is no model
override.
...
10 requests, 501,650 request-body bytes, and a conservative $4.37942675 Batch
upper estimate. Replay produced the same plan hash
`12114c6d946d0704ec12a1cdd7dda2bf4d16d264d569ceb4b307da935267f48c`.
