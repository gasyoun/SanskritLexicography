...
- [`glossaries/`](glossaries/README.md) — shipped register glossaries (épig, bhāṣya, kāvya,
  bauddha, jaina + cross-axis slices), generated by `renou_glossary.py REGISTER`.
- [`papers/A34_renou_register_note.md`](../../papers/A34_renou_register_note.md) — the data
