...
O = {
 ...
 # H2047 / MG 31-07 LOCK: visible RU = Latin form (not акк./лок./…); LES only in tooltip/legend.
 'Acc.': dict(b='a', cls='лат', ru='Acc.',
      note='MG 31-07 stay-Latin: tooltip A. - accusativus - винительный падеж'),
 'acc.': dict(b='a', cls='лат', ru='Acc.',
      note='case-fold of Acc.; same Latin-stay family'),
 'Loc.': dict(b='a', cls='лат', ru='Loc.',
      note='MG 31-07 stay-Latin: tooltip L. - locativus - местный падеж'),
 'loc.': dict(b='a', cls='лат', ru='Loc.', note='case-fold of Loc.'),
 'locc.': dict(b='a', cls='лат', ru='Loc.', note='plural loc.; Latin-stay family of Loc.'),
 'Instr.': dict(b='a', cls='лат', ru='Instr.',
      note='MG 31-07 stay-Latin: tooltip I. - instrumentalis - творительный падеж'),
 'instr.': dict(b='a', cls='лат', ru='Instr.', note='case-fold of Instr.'),
 'Abl.': dict(b='a', cls='лат', ru='Abl.',
      note='MG 31-07 stay-Latin: tooltip Abl. - ablativus - отложительный падеж'),
 'abl.': dict(b='a', cls='лат', ru='Abl.', note='case-fold of Abl.'),
 'Dat.': dict(b='a', cls='лат', ru='Dat.',
      note='MG 31-07 stay-Latin: tooltip D. - dativus - дательный падеж'),
 'dat.': dict(b='a', cls='лат', ru='Dat.', note='case-fold of Dat.'),
 'datt.': dict(b='a', cls='лат', ru='Dat.', note='plural dat.; Latin-stay family of Dat.'),
 'Gen.': dict(b='a', cls='лат', ru='Gen.',
      note='MG 31-07 stay-Latin: tooltip G. - genitivus - родительный падеж'),
 'gen.': dict(b='a', cls='лат', ru='Gen.', note='case-fold of Gen.'),
 'Nom.': dict(b='a', cls='лат', ru='Nom.',
      note='MG 31-07 stay-Latin: tooltip N. - nominativus - именительный падеж'),
 'nom.': dict(b='a', cls='лат', ru='Nom.', note='case-fold of Nom.'),
 'Nomin.': dict(b='a', cls='лат', ru='Nom.', note='variant of Nom.; Latin-stay'),
 'nomin.': dict(b='a', cls='лат', ru='Nom.', note='case-fold of Nomin.'),
 'Voc.': dict(b='a', cls='лат', ru='Voc.',
      note='MG 31-07 stay-Latin: tooltip V. - vocativus - звательный падеж'),
 'voc.': dict(b='a', cls='лат', ru='Voc.', note='case-fold of Voc.'),
 ...
 'dopp.': dict(b='a', cls='нем', ru='двойн.',
      note='«dopp. Acc.» = «двойн. Acc.» (case stays Latin, MG 31-07)'),
