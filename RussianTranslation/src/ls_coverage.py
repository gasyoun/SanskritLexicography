...
def md_table(per, pfull, source_label):
    ...
    L.append('- **`DHĀTUP. x,y` → Palsule (H1333):** %d / %d citations carry a gaṇa,serial '
             ...
             'index). Palsule has no online edition, so the datum is tooltip text carrying the '
             'printed page (`P167`), never an href; the gaṇa-level Westergaard link is unchanged.'
