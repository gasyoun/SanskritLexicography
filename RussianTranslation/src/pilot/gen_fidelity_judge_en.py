...
RUBRIC = (
    ...
    "mishandled (criterion 1 semantic). CHECK GERMAN HOMOGRAPHS/POLYSEMES BY HAND — markup stays "
    "intact and the English reads fluently, so NO deterministic gate can catch these; verify the "
    "sense against the Sanskrit lemma, not the frequent German reading: Vergleich (comparison vs. "
    "settlement/pact — samaya licenses the latter), braut/Braut (brauen 'to brew' vs. Braut "
    "'bride' — a lower-case verb form is never the noun), gelten (to be valid/reputed as vs. to "
    "cost/be worth), Zug (a pull/draw/team vs. a train/procession — context-dependent), anführen "
    "(to cite/quote vs. to lead/command), and any other German gloss with >=2 live senses\n"
