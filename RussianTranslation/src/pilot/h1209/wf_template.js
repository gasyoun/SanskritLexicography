...
// H2226 OPT-4: target field + controller prompt come from the payload (manifest-driven
// via prep_slice), not hardcoded Russian. Default russian keeps pre-parameterized RU
// payloads (v3 with field omitted) behaviourally identical.
...
// {key1} is substituted; the senses JSON is appended by controllerReview.
