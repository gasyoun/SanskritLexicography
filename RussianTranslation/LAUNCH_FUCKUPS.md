...
[
  ...
  },
  {
    ...
    "handoff": "H442",
    "date": "2026-07-10",
    "title": "H442 landed 2 heal-lane guardrails (per-card budget + kill-bisect depth cap, PR #301); both w1b re-runs still 0/12 audit-clean because the generation env is persistently degraded (3 conn-errors + 58/76 kill-timeouts each) -- lane paused on infra, not code",
    "lane": "nominal medium (band-4, 3-30 citation size), singleton cards",
    "model": "claude-sonnet-5",
