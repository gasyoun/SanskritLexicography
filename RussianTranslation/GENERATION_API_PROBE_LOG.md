...
| 2026-07-22T10:05:37Z | warmup | GO | 19.6s | 0 | 6828B | — | H1209 | Fresh c4 gate-0 health PASS at MG request (c4->c1->c5->c6 fallback; c4 passed first try). warm-up 22766 ms / measured 19635 ms, 0 conn-err, payload 6828B schema-carrying. Serial multi-profile wrapper over mao.live_probe. Unblocks H1209 medium50 resume; stale-GO rule still applies at actual launch. |
| 2026-07-23T06:06:12Z | warmup | NO-GO | — | 0 | 6828B | h858-partb-gate0 | H858 | H858 Part B precondition. c4 alive but ~1.6x worse than 22-07 morning PASS; NO-GO on latency. Fell through to c1->c5->c6. |
| 2026-07-23T06:11:42Z | warmup | NO-GO | — | 0 | 6828B | h858-partb-gate0 | H858 | Fallback c1 rate_limit -> fail-closed STOP. |
| 2026-07-23T06:12:32Z | warmup | NO-GO | — | 0 | 6828B | h858-partb-gate0 | H858 | Fallback c5 rate_limit -> fail-closed STOP. |
| 2026-07-23T06:13:11Z | warmup | NO-GO | — | 0 | 6828B | h858-partb-gate0 | H858 | Fallback c6 auth -> fail-closed STOP. FLEET-WIDE NO-GO (c4 latency, c1+c5 rate_limit, c6 auth): whole c-profile headless transport unusable this window. H858 Part B stays BLOCKED on gate; no code landed. Resume needs a fresh health PASS on any profile; Workflow-agent() lane (H1209 18-07) may be a green alternative route. |
