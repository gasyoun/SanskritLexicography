...
[
  ...
  },
  {
    ...
    "tracking": "",
    "verified_sha256": {
      "src/corpus_gate.py": "124c68f9d35295c1f5971923aef31573c7a93d1e4497a818c21fbcad957f460f",
      "src/pilot/window_selftest.py": "41f3ff552969a7f2b38029c4359c951734122dbf8af352e84f04808deac898b9"
    }
  },
  {
  ...
  },
  {
    ...
    "tracking": "",
    "verified_sha256": {
      "src/store_path.py": "c040c1eda1b71272b006695ea247687ee9a4211d70cca25b3ce68f6bc7501d83",
      "src/promote_final_cards.py": "4e93cd605f13d99e0eb21dbd9c5e26d42523b8031e2c5e9a6beb27a6b7240401",
      "src/promote_en.py": "9ff2b119687d997373d9743bb1474b158c2543af0756dcc61bc24034c38f00f8"
    }
  },
  ...
  },
  {
    ...
    "verified_sha256": {
      "src/pilot/gen_opt_harness2.py": "30808a8033f44329e810ee185d7477e66a5c653ffe5f90242a64332c596f8151",
      "src/pilot/headless_worker.py": "9a1597ca2da3fe40dac137467142157995e7bc3a2c539390f01d42d852f0eb63",
      "src/pilot/max_account_orchestrator.py": "70e152271f3fb6c26e4eb0cf7cbe69f274b762c6a19e7449e86165bd0682d3e8",
      "src/pilot/coordinator.py": "28ec475a8e64d2e857623e2672a68c26caf1b830bf486d4604ad6123137002c2",
      "src/pilot/headless_worker_selftest.py": "5ee9cf3b202d46cf43976b2eba5ab28b156e3fc89346c0a8c3d08d80daa9b9cd",
      "src/pilot/max_account_orchestrator_selftest.py": "acf19a00c9d852659944f3da84013816ccd76b4289c7fd36142b47ce997edaf6",
      "src/pilot/no_pwg_scale_plan.py": "76ee38a6f4690cc4ace510004bed82140b1702fc2943db4ed19a2cacf014c01a",
      "src/pilot/windows100_selftest.py": "11c19bdeb665507cc2d40311c5b1da577412c534986fd8e98172231a99c85dea",
      "src/pilot/run_observability.py": "6af8a6c0e5cca92f70bd48696fad84a20e9f07564f3f066f944c9ef4b7da2969",
      "src/pilot/run_observability_selftest.py": "75bc960a35080a0c84ca9b5ee62b63134a9e0bde334c5531d564b13019187b60",
      "src/pilot/proc_tree.py": "fb10b14935c5601b465e11b80f6e758cd151d490dfd5172cb9aaeb7c33e6e8e4"
    }
  },
  {
  ...
  },
  {
    ...
    "verified_sha256": {
      ...
      "src/pilot/sense_count.py": "e3ad886f8751f5e5ef877bf96219140bc5c8ccca5b02bb2e33f7f6620ec5db2c",
      "src/pilot/window_selftest.py": "41f3ff552969a7f2b38029c4359c951734122dbf8af352e84f04808deac898b9",
      "src/pilot/accept_sensecount_test.js": "d644b3916760fa303a5aeb52e40e6d5e3f42a3db84b9a05da28cf8cf2427d3a8"
    }
  },
  {
  ...
  },
  {
    ...
    "verdict": "SHARED",
    "note": "H3152 (19-08-2026, Opus 5 `claude-opus-5`). An insertion point is a property of the STRUCTURE, not of the language, so the two glue renderings must agree on it exactly — that is asserted, not assumed: the parity gate parses the emitted markdown rather than comparing the shared object (an object-level comparison would be true by construction and prove nothing). The delta sign is deliberately computed from the GERMAN originals on both sides, because the restatement relation holds between the sources and not between their translations; the Russian card therefore shows a sign derived from German, and that is intended, not a leak. LANG_TITLE/LANG_HOM/LANG_LEGEND/LANG_BOUND/LANG_UNBOUND are the per-language substitution points. Pinned by build_reglue.selftest (German bodies on the German card, identical insertion points) and by the 15-headword pilot build, which reports parity for every card. H3501 (25-08-2026, OxAlpha): re-derived, SHARED stands. The drift is sense ORDER only: build_reglue's skeleton sort now orders prefixed tags numerically by family (verb.1...verb.10, unnumbered intro last) instead of lexicographically (which rendered verb.10 before verb.2). The sort runs on the shared skeleton BEFORE any language rendering, so ru and de reorder identically from the same loop, no language branch exists, and B5's insertion_points parity gate passed on the rebuild ('parity: ru and de glue agree on every insertion point', 15/15 byte_ok=True). Fixture selftest pins the four ordering behaviours.",
    "tracking": "",
    "verified_sha256": {
      "src/build_reglue.py": "cc826a1a314cd6dd5ca0c91077b4ac8215846a67207e40e97f8d24f6a6f382f5",
  ...
  },
  {
    ...
    "verdict": "SHARED",
    "note": " H3510 re-stamp (25-08-2026, Fable 5 `claude-fable-5`): re-derived, verdict stands. The drift since this entry's stamp is H3500 (#1884): `merge_store_rows` collapses incoming duplicates keyed on `(sense_tag, ru)` and lands from the collapsed map (21 lines). The key names a RU field, so this was re-derived on the call graph, not asserted: `promote_en.py` never imports or calls `merge_store_rows` (0 hits), so the RU-only merge cannot reach the EN lane; the EN store writer still shares only the P9 `_atomic_write_rows` primitive. Nothing this entry tracks outside that function changed. Merged un-stamped, which turned the required gate red on master.",
    "tracking": "",
    "verified_sha256": {
      "src/pilot/requeue_from_audit.py": "c99752277f85228dec175c1c331382a1d3ead769dc71b0d64cdfbb6e517a6345",
      "src/pilot/translation_memory.py": "e5452394c8f3bbebef9f6038362e6a9d0e162a338201cdf425191412c7cf3a38",
  ...
  },
  {
    ...
    "tracking": "",
    "verified_sha256": {
      "src/pilot/xref_vocab.py": "6d2cdf43c7c76b68dc861d97015b1028f5d0a899559824fc0963c31653b638fa"
    }
  },
  {
    "id": "degenerate_xref_ru_rendering_h3658",
    "mechanism": "xref_vocab.render_xref_ru renders a degenerate cross-reference stub's apparatus into RUSSIAN (bare closed-vocabulary German -> Russian; {#..#} spans and whole <ab>/<ls>/<hom> regions verbatim), consumed only by gen_opt_harness2.degenerate_passthrough_card when field == 'russian'. The EN lane keeps H1422 P3's empty target field.",
    "files": [
      "src/pilot/xref_vocab.py",
      "src/pilot/gen_opt_harness2.py"
    ],
    ...
    "verdict": "INTENTIONAL-DIVERGENCE",
    "note": "H3658 (29-08-2026, Opus 5 claude-opus-5). P3 (H1422) kept the target field EMPTY so verbatim German could never leak; the side effect was that every degenerate_passthrough card auto-failed empty_russian + dropped_sanskrit_span, landed on requeue.defect.keys.txt, and (the defect guard being all-or-nothing) could block a whole paid batch — pa_tin in the H3654 window. RU can be rendered because a Russian display convention for this vocabulary is already RULED and shipped: pwg_ab_ru.RU_MAP ('s. u.' -> 'см.', MG 10-07-2026, ABBREVIATIONS_RU.md sec. 1), and xref_vocab.selftest pins the two maps against drift. EN is NOT a gap-by-oversight: no equivalent EN editorial-abbreviation ruling exists (pwg_ab_ru is RU-only by construction), so an EN twin would have to invent a display convention rather than apply one — that is an editorial decision, not a port. The DIVERGENCE is therefore the rendering, not the vocabulary: DEGENERATE_XREF_WORDS stays the one shared frozenset both lanes key off (see degenerate_xref_vocab_shared), and render_xref_ru fails closed to P3's empty field on anything outside it, so the German-leak guarantee is identical in both languages. Pinned by window_selftest.test_degenerate_passthrough_no_german_in_target (asserts the EN empty field AND the RU no-bare-German invariant) and by `python src/pilot/xref_vocab.py` (12/12, registered in CI).",
    "tracking": "an EN twin needs an EN editorial-abbreviation ruling first; until one exists this is divergence by design, not a tracked gap",
    "verified_sha256": {
      "src/pilot/xref_vocab.py": "6d2cdf43c7c76b68dc861d97015b1028f5d0a899559824fc0963c31653b638fa",
      "src/pilot/gen_opt_harness2.py": "30808a8033f44329e810ee185d7477e66a5c653ffe5f90242a64332c596f8151"
    }
  ...
  },
  {
    ...
    "verdict": "SHARED",
    "note": "H2224 (02-08-2026, Grok 4.5 `grok-4.5`): residual EN defect refuse + ready_partial filter closed on promote_en (OPT-1). Prior history: wall_clock SHARED via audit_window_en (H1618); H2077/H2095 infra-partial classification; incidental re-stamps H1957/H2095 merge. H3510 re-stamp (25-08-2026, Fable 5 `claude-fable-5`): re-derived, verdict stands. The drift since this entry's stamp is H3500 (#1884): `merge_store_rows` collapses incoming duplicates keyed on `(sense_tag, ru)` and lands from the collapsed map (21 lines). The key names a RU field, so this was re-derived on the call graph, not asserted: `promote_en.py` never imports or calls `merge_store_rows` (0 hits), so the RU-only merge cannot reach the EN lane; the EN store writer still shares only the P9 `_atomic_write_rows` primitive. Nothing this entry tracks outside that function changed. Merged un-stamped, which turned the required gate red on master. H3627 re-stamp (28-08-2026, Opus 5 `claude-opus-5`): hash-only. The `window_selftest.py` drift is two ADDED tests — `test_h3627_structured_output_exhaustion_is_parked_not_window_fatal` and `test_h3627_aborted_window_still_yields_its_paid_cards` — pinning the FINDINGS §596 salvage/park behaviour. No existing test, constant or verdict subject was modified, so this entry's ruling was NOT re-derived here and stands as its own author established.",
    "tracking": "https://github.com/gasyoun/Uprava/blob/main/handoffs/H2224-Grok_SanskritLexicography_pwg-opt1-en-promote-parity_02.08.26.md",
    "verified_sha256": {
      "src/pilot/window_reports.py": "a8e72de3bced4f00265753e8b8b305500f2584a1734501e5dca297c8e95485a8",
      "src/pilot/audit_window.py": "6924329df761ca120a0f58c81403936913f7675fdcd086eefaee3d10e6de3fef",
  ...
  },
  {
    ...
    "mechanism": "Per-subcard edition_rel structured flags (H180 typology machine classes: base/restate/pw_correct/sch_star/derived_sense/a2a/nws_at_sense/foreign_fragment/pwg_internal_correction/sch_correct/sch_cancel) via edition_rel.classify_edition_rel; stamped at promote; annotate_edition_rel backfills with PWG gender index; build_relationships reuses the same classifier for sidecar+rollup. DE text not rewritten. H2880 wave 2 keys the pwg_internal_correction class off sense_tag and layer only — neither is language-keyed — so the verdict stays SHARED. H2881 wave 3 keys sch_correct/sch_cancel off the German SOURCE text (`de`) plus layer — `de` is the one text both lanes translate FROM, and pw_correct (lex_genders) and foreign_fragment (guess_lang) already read it under this same SHARED verdict — so the verdict stays SHARED.",
    "files": [
      "src/edition_rel.py",
    ...
    "verdict": "SHARED",
    "note": "H1624 G4 (25-07-2026, Grok 4.5). Joins relationships_rollup classes onto the card graph. Promote stamps layer-rule defaults; full-store annotate enables pw_correct. Pinned by edition_rel --selftest, annotate_edition_rel --selftest, promote_final_cards --selftest. H2095 merge re-stamp (01-08-2026, Opus 5 `claude-opus-5[1m]`): hash-only. This entry's verdict was NOT re-derived here and the drift is NOT H2095's — it comes from merging origin/master's H2089 (`silent-empty workflow_payload + promote merge guard`), which touched `window_selftest.py` / `promote_final_cards.py` / `workflow_payload.py`. Re-stamped so the ledger is consistent in the merge commit; the substantive verdict remains whatever H2089's own author established. H2191 (03-08-2026, Opus 5 `claude-opus-5[1m]`): re-derived, SHARED stands. The drift is the stable-left prompt reorder: `build_prompt`, `fragment_prompt`, the two generated-harness JS twins and `h1209/prep_slice.prompt_common` now assemble `preamble + translation + grammar + [nws] + card blocks` instead of the historical `preamble + grammar + translation + ...`, so the run-invariant framework (preamble + CONV_TR) is the leftmost bytes ahead of the window-scoped grammar block, lengthening the stable head any provider-side prefix match can reuse. Re-derived mechanically, not asserted: the entire pilot diff is a permutation of three segments that were all already being sent, plus comments and one new selftest, and every changed line was grepped for a language-keyed token (`lang` / `russian` / `english` / `--lang` / `FIELD[` / `CARD_FIELD`) with ZERO hits. Nothing was dropped or compressed -- lean-TR stays rejected (AB_TEST_LEAN_TR.md); the identical bytes are sent in a different order. The order is fixed in the shared assembly with no language branch, so the RU and EN lanes reorder identically. Pinned by `headless_worker_selftest.test_h2191_prompt_is_assembled_stable_left`, which asserts the segment order, that each segment still appears exactly once, that the H2158 `split_prompt` byte-identity with `build_prompt` still holds, and that the old JS order is absent from the generator. H2879 (16-08-2026, Opus 5 `claude-opus-5`): re-derived, SHARED stands. The drift is the placement axis — `normalize_sense_tag`, `build_pwg_sense_index`, and the `placement` / `placement_reason` / `placement_hypothesis` fields split the 'what kind of supplement is this' claim from the 'does it have an identified target' claim, which `subtype` previously carried at once. Re-derived mechanically, not asserted: every field the new code reads is structural (`layer`, `sense_tag`, `key1`, `subcard`), and every changed line was grepped for a language-keyed token (`lang` / `russian` / `english` / `--lang` / `FIELD[` / `CARD_FIELD` / `'ru'` / `'en'`) with ZERO hits. Neither `ru` nor `en` card text is read, written, or branched on, so the RU and EN lanes gain the axis identically. Pinned by `edition_rel --selftest` (positives, the mandatory negatives, idempotence, and one case per `placement_reason`) and by `src/placement_axis_check.py`, the re-runnable acceptance gate. H2881 (16-08-2026, Opus 5 `claude-opus-5`): re-derived, SHARED stands. The drift is wave 3 — `sch_correction_marker` / `sch_has_correction_clause` and the `sch_correct` / `sch_cancel` classes, which let the `sch` layer come out corrective at all; before them it could only be `sch_star` or `derived_sense`, so 'SCH only supplements' was a property of the classifier rather than a measurement. Re-derived mechanically, not asserted: every changed line was grepped for a language-keyed token (`lang` / `russian` / `english` / `--lang` / `FIELD[` / `CARD_FIELD` / `'ru'` / `'en'`) with ZERO hits — the only matches are the substring `lang` inside `erlangen`/`source_lang` (a pre-existing passthrough key) and `FIELD` inside the word `fields`. One extension over H2879's claim is stated rather than glossed: this class reads `de`, which H2879's note did not, since its inputs were purely structural. `de` is the German SOURCE both lanes translate FROM — never `ru` or `en` — and two classes already in this SHARED entry read it (`pw_correct` via `lex_genders(de)`, `foreign_fragment` via `guess_lang(de)`), so the RU and EN lanes gain the classes identically. Pinned by `edition_rel --selftest` (the 7 printed cues, the 9 look-alike negatives that are the actual criterion, the non-leading-clause trap, and the DERIV_RE precedence case) and by gates W3a–W3e in `src/placement_axis_check.py`. H3510 re-stamp (25-08-2026, Fable 5 `claude-fable-5`): re-derived, verdict stands. The drift since this entry's stamp is H3500 (#1884): `merge_store_rows` collapses incoming duplicates keyed on `(sense_tag, ru)` and lands from the collapsed map (21 lines). The key names a RU field, so this was re-derived on the call graph, not asserted: `promote_en.py` never imports or calls `merge_store_rows` (0 hits), so the RU-only merge cannot reach the EN lane; the EN store writer still shares only the P9 `_atomic_write_rows` primitive. Nothing this entry tracks outside that function changed. Merged un-stamped, which turned the required gate red on master.",
    "tracking": "H1624",
    "verified_sha256": {
  ...
  {
    "id": "target_anchor_repair_h3675",
    "mechanism": "A card whose TARGET-language field dropped a masked {Tn} span while its `german` SOURCE echo stayed faithful is repaired from that same sense's german parallel (each dropped span re-injected next to its nearest surviving neighbour WITHIN the sense, with the sense start and sense end as virtual anchors) instead of being nulled by the H1152 C1 `count_card_field` guard. Repair-then-verify: it runs ONLY on a card that already failed that count, and the same count is re-run as the verifier on BOTH sides, so a passing card is byte-untouched. Refused unless the target echo is a strict order-preserving subsequence of that sense's german. Both lanes are driven from one authored source — target_anchor.py, whose js_source() is interpolated into the harness (the C-01/C-17 pattern, same as german_anchor).",
    "files": [
      "src/target_anchor.py",
      "src/pilot/headless_worker.py",
      "src/pilot/gen_opt_harness2.py"
    ],
    "languages": [
    ...
    "verdict": "SHARED",
    "note": "H3675 (29-08-2026, Opus 5 `claude-opus-5`). The target-side twin of german_anchor_repair_h858, built after FINDINGS §605/§608 established that the source-side repair can never fire on this failure path and — replayed offline against `hasita~~h0_zz_pw` — would refuse it with `nothing-missing` even if it did. MG ruled `reanchor` over an explicit requeue on 29-08-2026, overriding the PR #789 boundary-guessing refusal FOR THIS CLASS only: PR #789 declined to reconstruct a `{%…%}` gloss boundary from prose, whereas a `{Tn}` token is opaque and atomic and the same sense's german still carries every one of them in order, so the position is read off a surviving parallel rather than inferred. Language-agnostic BY CONSTRUCTION: the target field is a PARAMETER, never a literal, and the anchor is always `german`, which is identical on the RU and EN lanes — `test_h3675_target_anchor_selftest` asserts both mechanically (identical repair for target='russian' and 'english'; the german anchor field untouched; no language literal anywhere in the emitted JS). Adding a third language changes nothing here. What the store may receive is UNCHANGED: only cards that count exactly right on both sides; a target echo that is not a pure drop still rejects, now carrying its refusal reason (`translation-fidelity-reject: target-anchor <reason>`, prefix preserved so every existing reader still matches). A card dropped on BOTH sides is repaired twice and keeps both stamps — pinned, because the target repair re-restores from `masked` and would otherwise silently lose the german provenance. Pinned by target_anchor.selftest() (10 cases), headless_worker_selftest.test_normalize_batch_translation_fidelity_reject and test_normalize_batch_german_anchor_repair, and target_anchor_test.js against a real generated harness.",
    "tracking": "H3675",
    "verified_sha256": {
  ...
  {
    "id": "router_cheap_dispatch_contract_h2554",
    "mechanism": "Single-source synthetic canary contract plus exact Agent tool_use/tool_result dispatch binding across ticket, wrapper, attestation, envelope, recovery, and protocol schemas",
    "files": [
      "src/pilot/gateway_canary_contract.py",
      "src/pilot/gateway_external.py",
      "src/pilot/gateway_attestation.py"
    ],
    "languages": [
      "ru",
      "en"
  ...
  },
  {
    ...
    "tracking": "H2684",
    "verified_sha256": {
      "src/pwg_tm_generate.py": "d00f4fd78f709156df785e0c40152adc15a9c1036a2254d334a7c8f8111f3ce1",
      "src/pwg_tm_gates.py": "96699d465e72c180b4065447734fa0472445ededf64068c0f89660721adf29c6",
  ...
  {
    "id": "plan_mode_task_shape_preamble_h3144",
    "mechanism": "Plan-mode-compatible TASK SHAPE block at the head of gen_opt_harness2.MASK_PREAMBLE, so a headless `claude -p --json-schema --permission-mode plan` call does not refuse to emit structured output; pinned by window_selftest.test_mask_preamble_carries_task_shape",
    "files": [
      "src/pilot/gen_opt_harness2.py",
      "src/pilot/window_selftest.py"
    ],
    ...
    "verdict": "SHARED",
    "note": "H3144 (19-08-2026, Opus 5 `claude-opus-5`): the production spawn passes `--permission-mode plan` together with `--json-schema`. On 19-08-2026 the c1 canary returned a null card reported as `malformed_output: … Expecting value: line 1 column 1 (char 0)`; the CLI session transcript shows the model DECLINED to emit structured output on plan-mode grounds (\"the tools that workflow expects me to end with (AskUserQuestion, ExitPlanMode) aren't even available to me in this session\"), refused again against the CLI's own `[structured-output-enforce]` retry, and the harness then fell back to the prose in `result`. The call billed in full. MG ruled option B — keep plan mode, reframe the prompt — the same fix H994 applied to the health probe on 15-07-2026. The new TASK SHAPE block opens `MASK_PREAMBLE`, which both lanes consume via the same `.replace('`russian`', field)` call; it names no target field, no language and no lang-branching behaviour, so it reaches RU and EN identically by construction. `test_mask_preamble_carries_task_shape` pins the block's presence and forbids reintroducing the bare tool-demand shape the model refused twice. Uprava FINDINGS §498. H3627 re-stamp (28-08-2026, Opus 5 `claude-opus-5`): hash-only. The `window_selftest.py` drift is two ADDED tests — `test_h3627_structured_output_exhaustion_is_parked_not_window_fatal` and `test_h3627_aborted_window_still_yields_its_paid_cards` — pinning the FINDINGS §596 salvage/park behaviour. No existing test, constant or verdict subject was modified, so this entry's ruling was NOT re-derived here and stands as its own author established.",
...
```json lang_parity_coverage
{
  ...
  "exempt": {
    ...
    "src/pilot/deterministic_lane_census.py": "Read-only lane census (Phase 0 of the deterministic-first remake, #1873, 24-08-2026): reads prepared untranslated inputs, calls the production classifiers to bucket each card A/B/C/E, and writes one dated .md + .json report pair; never translates, transforms a card, writes the store, or emits a gate/promote verdict, so a change to it cannot cause RU/EN behavioural drift. Flagged 25-08-2026 by the coverage guard during H3169 — it landed with #1873 and was never classified, so the gate was red on master before that PR touched it. NOTE for whoever next edits it: `census()` takes `--lang ru|en` and `tm_card_sane` picks `russian`/`english` correctly, but the lane-B probe at `census()` hardcodes `degenerate_passthrough_card(..., 'russian')` regardless of `lang`, so an `--lang en` census measures lane B against the Russian field. That is a defect in the REPORT, not in pipeline behaviour, which is why this is exempt rather than a GAP ledger entry — fix it in the census's own handoff, and re-classify here if the file ever gains a store write or a verdict.",
