...
_Created: 04-07-2026 · Last updated: 01-08-2026 (H2091 #948: 5 entries re-derived, SHARED stands — `_selfheal_stop_reason` is now RANKED (budget stop, then any other typed infra reason, then the historical content verdict), so a dead CALL no longer reports itself as a content defect; a dead call kills the RU and EN lanes identically)_
