...
[
  ...
  },
  {
    ...
    "verified_sha256": {
      ...
      "src/pilot/prompt_rule_audit.py": "b235136ea95a7c77eb2cee0a3a6bc393c75df221ba587253a7949d9e3cbe4927",
      "src/pilot/audit_window.py": "674c0886d6fea0ed15032c14c9e31739071ae137180d69aa9a1953233f5f206d",
      "src/pilot/audit_window_en.py": "af981a0f4c11f7021ecad2c23eaa444455a743bfeca7eb0457a5f2ef9c2b68d6"
    }
  },
  {
  ...
  },
  {
    ...
    "verified_sha256": {
      "src/pilot/gen_opt_harness2.py": "a12ce11933d54742d015bc7b65ed112f9640dfb134ae3be69993d48a4296cac0",
      "src/pilot/headless_worker.py": "a2aedb51b3f0c3d7a10c83398a73978f30624ef0d27dae013289fc6406568181",
      "src/pilot/max_account_orchestrator.py": "5b460b0ddb96a7bf12aa5a9baf023d9dbb5c528438c91e9b80469f7d49d55123",
      "src/pilot/coordinator.py": "d86579be2a96e8df3e69c50035a69929d7f6ee35448f1d4c7b370211efb7b86b",
  ...
  },
  {
    ...
    "verdict": "SHARED",
    "note": "H2226 OPT-4 (02-08-2026, Grok 4.5 `grok-4.5`): wf_template.js takes TARGET_FIELD + CONTROLLER_PROMPT from the payload (prep_slice writes field + controller_prompt_for_field from the manifest); default russian keeps pre-parameterized RU args identical. canonical_audit.py was already field-parameterized. Proved: det_gate EN field path + js_field_param_selftest RU/EN inject under WORKFLOW_SCRIPT_CAP; committed RU 3-card canary (slice_result2) still clean under canonical_audit. Live paid EN campaign is still non-goal of H2226 — scaffold only, no second EN tree. H2243 re-verify (03-08-2026, Sonnet 5 `claude-sonnet-5`): this entry's `verdict`/`languages`/hashes had been REVERTED to the pre-H2226 GAP state by the later H2227/OPT-2 merge (`72c8311d`), which rebased over a pre-H2226 base and carried the stale ledger content forward — the actual `wf_template.js`/`prep_slice.py` on disk were NOT reverted and still contain the H2226 field-parameterization (`TARGET_FIELD = PAYLOAD.field || 'russian'` etc., current sha256 == H2226's originally-stamped hashes below). Confirmed by direct hashing of the working-tree files, not by re-deriving the diff again. Restored to H2226's verdict/hashes; this is a ledger-doc regression fix, not a re-affirmation of fresh code drift.",
  ...
  },
  {
    ...
    "verdict": "SHARED",
    "note": "H2226 OPT-4 (02-08-2026, Grok 4.5 `grok-4.5`): closed the RU-bound JS residual named by the prior GAP — wf_template_ab.js + control_template.js now take TARGET_FIELD + CONTROLLER_PROMPT from the payload (same contract as h1209/wf_template.js); arm_b_control.senses_of + cmd_build inject field/controller_prompt; det_gate fidelity messages name the active field. Analysis trio and packers remain language-neutral. Do not fork a second EN scaffold tree. Live paid EN A/B spend remains non-goal — mini-EN inject build proven via js_field_param_selftest. H2243 re-verify (03-08-2026, Sonnet 5 `claude-sonnet-5`): this entry's `verdict`/`languages`/hashes had been REVERTED to the pre-H2226 GAP state by the later H2227/OPT-2 merge (`72c8311d`), same regression as the sibling h1209_controller_worker_rig entry — the actual det_gate.py/arm_b_control.py/control_template.js/wf_template_ab.js on disk were NOT reverted and still carry the H2226 field-parameterization (current sha256 == H2226's originally-stamped hashes below, directly re-hashed). Restored to H2226's verdict/hashes; ledger-doc regression fix, not a re-affirmation of fresh code drift.",
    "tracking": "https://github.com/gasyoun/Uprava/blob/main/handoffs/H2226-Grok_SanskritLexicography_pwg-opt4-h1209-js-field-param_02.08.26.md",
    "verified_sha256": {
  ...
  },
  {
    ...
    "verified_sha256": {
      "src/pilot/perf_preflight.py": "bc03b5b9878e526d3ffd9d2e5352bd1c1bcf69c8961ac37d673bafb9d6bf645b",
      "src/pilot/probe_log.py": "cc54311247f8446c4ad6de29e7b58ffb05d14e6d099d21b5418c8cf4989543c3"
    }
  },
  {
