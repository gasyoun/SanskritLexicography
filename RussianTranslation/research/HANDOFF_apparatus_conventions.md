...
**Evidence.**
- PWG — no class, derive from 3sg: *"Bei den Verbalwurzeln findet man keine Klasse angegeben, da diese sich aus der beigefügten 3. Person sg. praes. … von selbst ergiebt"* — [pwgpref_all.de.md L189](https://github.com/sanskrit-lexicon/PWG/blob/master/prefaces/pwgpref_all.de.md).
