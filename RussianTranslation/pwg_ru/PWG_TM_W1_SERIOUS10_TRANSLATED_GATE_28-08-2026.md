...
| Floor | H2684 before | After the revert repair (H3611) | **After translation (this pass)** |
|---|---|---|---|
| fidelity ≥ 98 % | 99.50 % PASS | 97.25 % **FAIL** | **99.25 % PASS** |
| equivalence ≥ 95 % | 95.50 % PASS | 95.75 % PASS | **97.75 % PASS** |
| serious_error ≤ 1 % | 2.50 % **FAIL** | 0.00 % PASS | **0.00 % PASS** |

Independent judge `x-ai/grok-4.5`, blind, one call per row, H3299 pinned rubric: **serious 0/10, fidelity 9/10, equivalence 9/10**. `independence_errors` `[]`; no severity-consistency violations. Spend this pass **$0.181925**; **$0.481342** across all three judge runs.
