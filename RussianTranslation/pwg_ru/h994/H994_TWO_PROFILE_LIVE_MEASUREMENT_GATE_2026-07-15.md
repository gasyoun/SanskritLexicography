...
_Auto-generated by Opus 4.8 (`claude-opus-4-8[1m]`) as the H994 executor (pre-named H963), Ultracode;
two-profile live rung-1/2 measurement only, no canary generation, no promotion, no store/TM mutation._
