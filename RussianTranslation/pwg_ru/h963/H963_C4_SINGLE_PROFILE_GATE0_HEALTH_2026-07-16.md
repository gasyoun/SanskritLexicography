...
_Created: 16-07-2026 · Last updated: 31-07-2026 (**ROOT CAUSE: c4 is RATE-LIMITED — an authenticated probe outside the CLI returns HTTP 429 in ~1 s, so the CLI's apparent 120–300 s "hang" is silent retry/backoff. The sixth reading's "≈65 s is CLI startup" conclusion is RETRACTED, and the latency series is contaminated by backoff**)_
