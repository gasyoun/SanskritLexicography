...
_Created: 16-07-2026 · Last updated: 31-07-2026 (sixth reading appended — the route recovered and c4 still failed at 78 415 ms; the recovery ping's own envelope shows **≈65 s of that is CLI startup, not the route**, so under this host's load the ceiling is spent before a token moves)_
