...
**+)** [SCH·derived_sense → не привязано: цель не указана] 1. {%dhā%}¦  mit {%abhi%}, S. 152, Sp. 1, Z. 2 читай {%abhíhita%}.
...
**+)** [SCH·derived_sense → не привязано: цель не указана] — С {%abhyupa%} 3. вычеркни <ls>Med.</ls>
