...
**+)** [NWS·foreign_fragment → *new] ‹en› {#rakṣ#} [Gen , unsp] ( rákṣati I P ) хранить (тайну). Kathās . щадить, считаться с (чужими чувствами). Mālav . остерегаться, отражать, удалять, предотвращать, расстраивать, причинять вред. AV v, 1 . скрываться, бояться (?). ṚV x, 68, 1

**+)** [NWS·nws_at_sense → *new] {#rakṣ (=pw rakṣ 1)#} [Gen , unsp] защищать. Renou 1997, S. 69 . лишать, причинять ущерб. Renou 1997, S. 69

**+)** [NWS·nws_at_sense → *new] [Ved , unsp] защищать, оберегать кого-л. (Akk). беречь, охранять, хранить что-л. (Akk), поддерживать в его существовании. хранить, охранять божественные установления или законы (чтобы они не нарушались). [ о богах. ] оберегать кого-л. (Akk) от (Abl). med: внимательно наблюдать за (Akk, Lok). быть бдительным (на страже). Int: усердно хранить. Направительные слова ánu , abhí , ā́ , pári привносят к вышеуказанным значениям лишь едва уловимые оттенки

**+)** [NWS·nws_at_sense → *new] [Ved , unsp] ( I ) защищать, хранить, бдеть над

**+)** [NWS·nws_at_sense → *new] [Ved , unsp] ( I U ) охранять; беречь, стеречь, защищать. ṚV 4,33,4 , ṚV 4,50,2

**+)** [NWS·nws_at_sense → *new] [Ved , unsp] быть настороже, нести стражу. ṚV 10,68,1

**+)** [NWS·foreign_fragment → *new] ‹en› [Śā , Soc] ( I P, X P ) держать надзор над, остерегаться. KA 1.16.35

**+)** [NWS·foreign_fragment → *new] ‹en› [Jin , unsp , 1349 A.D. , Delhi] Kaus: велеть сохранить. Rajaśekharasuri 1935, S. 119, Z. 12

**+)** [NWS·nws_at_sense → *new] [Jin , unsp] расстраивать (замыслы), препятствовать. PPS, S. 101, Z. 32
...
**+)** [PW·restate → *new] <div n="1">— 3〉 {%остерегаться, предотвращать;%} mit <ab>Acc.</ab> [Page5-157-c]

**+)** [PW·restate → *new] <div n="1">— 4〉 <ab>Med.</ab> {%остерегаться,%} т.е. <ab>v. a.</ab> {%бояться%}.

**+)** [PW·restate → *new] <div n="1">— 5〉 <ab>Med.</ab> быть может, {%прятать%}.

**+)** [PW·restate → *new] <div n="m">— <ab>Caus.</ab> {#rakzayati#} {%защищать, — от%} (<ab>Abl.</ab>) {%сохранять%}.

**+)** [PW·restate → *new] <div n="m">— <ab>Desid.</ab> {#rirakzizati#} {%намереваться защитить от%} (<ab>Abl.</ab>).

**+)** [PW·restate → *new] <div n="m">— <ab>Intens.</ab> {#rArakzARa/#} {%усердно охраняющий%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#aDi#} {%охранять, оберегать%}. <ab>v. l.</ab> {#hi rakzati#} <ab>st.</ab> {#'Dirakzati#}.

**+)** [PW·restate → *new] <div n="p">— Mit {#anu#} {%следовать охраняя; оберегать, защищать%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#aBi#} стеречь, оберегать, защищать, — {%от%} (<ab>Abl.</ab>), {%лелеять, холить, сохранять, соблюдать%} (законы <ab>u. s. w.</ab>) Войско {%охранять,%} т.е. <ab>v. a.</ab> {%возглавлять%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#samaBi#} {%сохранять, оберегать, защищать%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#ava#} <ls>MBH. 8,45,43</ls> ошибочно. Под {#kzar#} было предположено {#avakzarantaH#} <ab>st.</ab> {#avarakzantaH#}, <ls>MBH. ed. Vardh.</ls> читает {#atitakzantaH#} (!)

**+)** [PW·restate → *new] <div n="p">— Mit {#A#} {%оберегать, защищать, сохранять, стеречь, — от%} (<ab>Abl.</ab>)

**+)** [PW·restate → *new] <div n="p">— Mit {#upa#} in {#uparakzaRa#}.

**+)** [PW·restate → *new] <div n="p">— Mit {#prani#}.
...
**+)** [PW·restate → *new] <div n="1">— 2〉 {%избегать;%} <ab>Med.</ab> mit <ab>Gen.</ab> {%избегать кого-либо, сделать так, чтобы не встретиться с кем-либо%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#saMpari#} {%защищать%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#pra#} {%сохранять, защищать от%} (<ab>Abl.</ab>), {%спасать от%} (<ab>Abl.</ab>).

**+)** [PW·restate → *new] <div n="p">— Mit {#prati#}
<div n="1">— 1〉 {%оберегать, защищать, соблюдать верно%} (обещание).
<div n="1">— 2〉 {%защищаться от, бояться%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#vi#} {%оберегать, защищать, сохранять%}.

**+)** [PW·restate → *new] <div n="p">— Mit {#sam#} {%стеречь, сохранять, защищать, охранять, оберегать, содержать, щадить, спасать, servare, — от%} (<ab>Abl.</ab>). {%обеспечивать, хранить, беречь%}.

**+)** [PW·restate → *new] <hom>2.</hom> √{#˚rakz#}¦ {%сохраняющий, охраняющий%} in {#gorakz#}.

**+)** [PW·restate → *new] <hom>3.</hom> √{#rakz#}¦ (nur {#rakzIs#}) {%повреждать, ранить%} <ls>AV.</ls>

**+)** [PW·restate → *new] <hom>1.</hom> √{#rakz#}¦ mit {#samanu#} {%блюсти, охранять%} <ls>DIVYĀVAD. 104,13</ls>. <ls n="DIVYĀVAD.">105,18</ls>.<info n="sup_7"/>

**+)** [PWKVN·a2a → *new] <hom>1.</hom> {#rakz#}¦ с {#samanu#} {%блюсти, охранять%} <ls>DIVYĀVAD. 104,13</ls>. <ls n="DIVYĀVAD.">105,18</ls>.

**+)** [SCH·sch_star → *new] 1. {%rakṣ%}¦ с {%samanu%} блюсти, охранять, <ls>Divyāvad. 104,13; 105,18.</ls> {part=,seq=22638,type=,n=2}
