...
[MBH. 13,2281.](https://sanskrit-lexicon-scans.github.io/mbhcalc?13.2281) = ≈Vulg. 13.40.35 = ≈krit. 13,40.35a *kṣudhā bhugnaḥ*
[12,4265.](https://sanskrit-lexicon-scans.github.io/mbhcalc?12.4265) = ≈Vulg. 12.118.8 = ≈krit. 12,118.8a *bharabhugnavitatabāhu*
...
[MBH. 1,5891.](https://sanskrit-lexicon-scans.github.io/mbhcalc?1.5891) = ≈Vulg. 1.149.2 = krit. —
...
[MBH. 13,6406.](https://sanskrit-lexicon-scans.github.io/mbhcalc?13.6406) = ≈Vulg. 13.141.18 = ≈krit. 13,128.18c
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **1.** √*bhuj*, *bhujati* biegen.
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *ava* einbiegen. *˚bhugna* niedergebogen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *pratyava* zurückbiegen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *ā* einbiegen. *paryaṅkamābhujya* die Beine beim Sitzen unterschlagend [VAJRACCH. 19,9. 10]. [KĀRAṆḌ. 85,8. 86,8]. *ābhugna* gebogen, gekrümmt, zur Seite gedrängt.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *vyā*, *˚bhugna* gebogen. _n._

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *ni* beugen, senken.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *nis* bei Seite legen, — schieben, aus der Stelle rücken, herausschieben aus (Abl. [ṚV. 6,62,6](https://sanskrit-lexicon.github.io/rvlinks/rvhymns/rv06.062.html#rv06.062.06)). *oṣṭhau* die Lippen verziehen. Pass. sich bei Seite drücken, entwischen. *nirbhugna* gebogen, verdreht (Augen).

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *vinis* bei Seite biegen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *pari* umspannen, umfangen. *˚bhugna* gebogen [BHAṬṬ.]

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *pra* beugen; falten, zusammenlegen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit **vi*, *˚bhugna* umgebogen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *pravi* umbiegen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *sam* umwinden [Comm. zu ĀPAST. ŚR. 7,11,5]. *saṃbhugna* zusammengebogen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **2.** *bhuj* in *tribhuj*.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **3.** √*bhuj*, *bhājati*, *bhunakti*, *bhuṅkte*, *bhuñjati* (*bhuñjatī* Partic. _f._). *˚te*, *bhukta* Partic.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 1〉 geniessen, Etwas zu geniessen haben, sowohl zu Nutzen haben, mit Nutzen besitzen, benutzen, sich dem Genuss von Etwas hingeben, als vom Genuss von Speisen; in der älteren Sprache mit Instr., in der späteren meistentheils mit Acc. ohne Object seine Mahlzeit halten und fressen (von Thieren); die Erde, ein Land, eine Stadt (Acc.) geniessen, den Nutzen von ihr haben, so v. a. beherrschen und sich in den Besitz setzen (von einem Fürsten gesagt); Jmd (Acc.) geniessen, so v. a. sich zu Nutzen machen, ausbeuten und geschlechtlich geniessen. In der späteren Sprache gewöhnlich Med.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 2〉 Etwas (Acc., ausnahmsweise Instr.) zu geniessen haben, so v. a. zu büssen haben bei Jmd. (Gen.) den Lohn für Etwas (Acc.) davontragen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 3〉 Act. Jmd (Acc.) zu Nutzen sein, zu Gute kommen, frommen, dienen. Einmal v. l. Med.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 4〉 in der Astr. durchlaufen, mit Acc. [Spr. 7740](https://sanskrit-lexicon-scans.github.io/boesp1/app1/?7740) (zugleich geniessen, verzehren) Eine best. Zeit durchlaufen, so v. a. verleben, währen, erfüllen, dauern. — Wird mit *yuj* verwechselt.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Caus. *bhojayati*. *˚te* (metrisch)

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 1〉 Jmd Etwas essen lassen, speisen mit; mit doppeltem Acc. oder mit Acc. der Person und Instr. der Sache.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 2〉 ausnahmsweise Jmd Etwas geniessen lassen überh.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 3〉 als Nahrung geniessen, — gebrauchen [CARAKA. 6,18].

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Desid. *bubhukṣati* (einmal), *˚te*

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 1〉 zu essen wünschen, hungrig sein.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 2〉 zu geniessen —, theilhaftig zu werden wünschen [NAIṢ. 6,100]. — *bubhukṣita* s. bes.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Intens.
— 1〉 *bobhujīti* geniessen.
— 2〉 *bobhujyate* vielfach verspeist werden.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *adhi* verspeisen, geniessen überh.
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *abhi* Jmd (Acc.) nützlich sein, dienen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *ā* in 2. **ābhoga*, *ābhogaya* u. s. w.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *samā* geniessen, so v. a. herrschen über (Acc.).
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *pratyupa* geniessen, verspeisen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *samupa* der Liebe pflegen mit (Acc.)
...
— 4〉 geniessen, benutzen, gebrauchen. — *paribhujyantam* [MBH. 11,97](https://sanskrit-lexicon-scans.github.io/mbhcalc?11.97) = ≈Vulg. 11.3.14 = ≈krit. 11,3.11c fehlerhaft für *˚bhṛjjyantam*. — *paribubhukṣita* s. bes. ([Nachtr. 4])
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *vi* in **bhuktavibhukta*.
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **4.** *bhuj*
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **3.** √*bhuj* mit *upa* Desid. zu geniessen (ehelich) Willens sein [HEM. PAR. 1,380].

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **3.** √*bhuj* mit *upa* Desid. 5.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **3.** *bhuj* mit *upa* Desid. zu geniessen (ehelich) Willens sein [HEM. PAR. 1,380].

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **3.** *bhuj* mit *upa* Desid. 5.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] 3. bhuj mit upa Desid. (ehelich) zu genießen willens sein, [Hem. Par. 1,380.] {part=,seq=20923,type=,n=2}
...
[MBH. 11,97](https://sanskrit-lexicon-scans.github.io/mbhcalc?11.97) = ≈Vulg. 11.3.14 = ≈krit. 11,3.11c liest die [ed. Bomb.] *paribhṛjjantam* (d. i. *˚bhṛjjyantam)* . Vgl. *paribhoktar* fg. — desid. partic. *paribubhukṣita* überaus hungrig
[MBH. 9,1483.](https://sanskrit-lexicon-scans.github.io/mbhcalc?9.1483) = ≈Vulg. 9.27.41 = ≈krit. 09,26.38c Kann auch in *pari + bu˚* zerlegt werden.
...
[MBH. 3,12672.](https://sanskrit-lexicon-scans.github.io/mbhcalc?3.12672) = ≈Vulg. 3.184.21 = ≈krit. 03,182.19c
...
[MBH. 3,1007.](https://sanskrit-lexicon-scans.github.io/mbhcalc?3.1007) = ≈Vulg. 3.27.34 = ≈krit. 03,28.32a
...
[MBH. 13,5009.](https://sanskrit-lexicon-scans.github.io/mbhcalc?13.5009) = ≈Vulg. 13.104.55 = krit. — *rājanme dīyatāmannaṃ sagaṇāya bubhukṣate*
[BHĀG. P. 9,21,8.](https://sanskrit-lexicon-scans.github.io/bhagp_bur/app1/?9,21,8) zu geniessen wünschen: *na sa rājyaṃ bubhukṣati*
[MBH. 1,5667.](https://sanskrit-lexicon-scans.github.io/mbhcalc?1.5667) = ≈Vulg. 1.140.78 = krit. —
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *pratyupabhoga* .

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *samupabhoga* .

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *pratibhoga* .
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *a˚, agra˚, anna˚, amṛta˚, kaṇa˚, kaṇṭaka˚*
