...
[MBH. 1,7979.](https://sanskrit-lexicon-scans.github.io/mbhcalc?1.7979) = ≈Vulg. 1.218.14 = ≈krit. 01,210.14c *sve sthāne śakaṭasyātha cakrabandhamakārayat* das Anbinden
...
[MBH. 7,8776.](https://sanskrit-lexicon-scans.github.io/mbhcalc?7.8776) = ≈Vulg. 7.191.22 = ≈krit. 07,164.132a *cakra˚ = cakre bandhaḥ*
...
[6,20,18.](https://sanskrit-lexicon-scans.github.io/ramayanagorr/?6,20,18) [5,44,13.](https://sanskrit-lexicon-scans.github.io/ramayanagorr/?5,44,13) [15.](https://sanskrit-lexicon-scans.github.io/ramayanagorr/?5,44,15) [MBH. 3,16466.](https://sanskrit-lexicon-scans.github.io/mbhcalc?3.16466) = ≈Vulg. 3.289.4 = ≈krit. 03,273.4a
...
[MBH. 14,443.](https://sanskrit-lexicon-scans.github.io/mbhcalc?14.443) = ≈Vulg. 14.16.36 = ≈krit. 14,16.35c
[Spr. 3609.](https://sanskrit-lexicon-scans.github.io/boesp1/app1/?3609)
[MBH. 1,165.](https://sanskrit-lexicon-scans.github.io/mbhcalc?1.165) = ≈Vulg. 1.1.211 = ≈krit. 01,1.152c [5,5225.](https://sanskrit-lexicon-scans.github.io/mbhcalc?5.5225) = ≈Vulg. 5.156.27 = ≈krit. 05,153.27c *rāja˚* Gefangensetzung durch den Fürsten
...
[MBH. 3,16312.](https://sanskrit-lexicon-scans.github.io/mbhcalc?3.16312) = ≈Vulg. 3.283.44 = ≈krit. 03,267.44a
...
[MBH. 5,5202.](https://sanskrit-lexicon-scans.github.io/mbhcalc?5.5202) = ≈Vulg. 5.156.4 = ≈krit. 05,153.4a *āsana˚* (hätte bei *āsana* unter 1, a gestellt werden müssen) das Sichsetzen
...
[MBH. 1,59](https://sanskrit-lexicon-scans.github.io/mbhcalc?1.59) = ≈Vulg. 1.1.105 = ≈krit. 01,1.63c in der Unterschr.
...
[51.](https://sanskrit-lexicon-scans.github.io/bhagavadgita/app1?2,51)
  — ＋ PW — 6〉 Jmd zurückhalten [NAIṢ. 6,107].
...
[9,35.](https://sanskrit-lexicon-scans.github.io/raghuvamsa/app1?9,35)
  — ＋ PW — 7〉 Jmd von sich weisen, fern halten von sich. *˚baddha* so v. a. mit dem man Nichts zu thun haben will.
...
[MBH. 1,6779.](https://sanskrit-lexicon-scans.github.io/mbhcalc?1.6779) = ≈Vulg. 1.176.21 = ≈krit. 01,166.17c
  — ＋ PW — 8〉 *pratibaddha* verwickelt, schwer zu lösen.

**9)** — 9) Sehne (am Körper): *pīvaraśca suvarṇaśca dṛḍhabandhaśca jāyate (mārjāraḥ)*
[MBH. 5,5437.](https://sanskrit-lexicon-scans.github.io/mbhcalc?5.5437) = ≈Vulg. 5.160.113 = ≈krit. 05,158.30c
...
[MBH. 4,2126.](https://sanskrit-lexicon-scans.github.io/mbhcalc?4.2126) = ≈Vulg. 4.66.21 = ≈krit. 04,61.21c
...
[MBH. 3,10727](https://sanskrit-lexicon-scans.github.io/mbhcalc?3.10727) = ≈Vulg. 3.134.24 = ≈krit. 03,134.24a; *banddhum* (hier und da fälschlich *baddhum), bandhitum*
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *upabandha* .

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *saṃnibandha* u. s. w.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *prabaddhar* fgg.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] —
...
[MBH. 10,756.](https://sanskrit-lexicon-scans.github.io/mbhcalc?10.756) = ≈Vulg. 10.16.34 = ≈krit. 10,16.33a *pītapratibaddhavatsā*
...
[MBH. 11,711.](https://sanskrit-lexicon-scans.github.io/mbhcalc?11.711) = ≈Vulg. 11.25.6 = ≈krit. 11,25.6a *dharmārthapratibaddhatā*
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 2) heften, richten: *mamedaṃ syāditi hi sarveṣāṃ tatrāśā pratibaddhā*
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 3) verschliessen, abschneiden: *pratibadhnāti hi śreyaḥ pūjyapūjāvyatikramaḥ*
...
[MBH. 8,2108.](https://sanskrit-lexicon-scans.github.io/mbhcalc?8.2108) = ≈Vulg. 8.45.38 = ≈krit. 08,30.74c *pratibaddha = manohata, pratihata, hata*
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 5) *pratibaddha* verwickelt, schwer zu lösen
[VARĀH. BṚH. S. 2,1.](https://sanskrit-lexicon-scans.github.io/brihatsam/app1?2,1)

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *pratibadhya (pratibandhya)* fgg.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *vibandha* .

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *abhisaṃbandha* .

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Vgl. *aṅka˚, artha˚* (auch
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 2〉 an Schnüren (Instr.) fassen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 3〉 inʼs Stocken bringen. *purīṣam* [CARAKA. 5,10]. *vibaddha* inʼs Stocken gerathen, verstopft.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 4〉 *vibadhnanti* [MÜLLER, SL. 178] fehlerhaft für *niba˚*.
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 2〉 herbei-, verschaffen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Caus.
— 1〉 anbinden lassen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — 2〉 verbinden heissen mit (Instr.) so v. a. sagen, dass man verbinden müsse.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] Mit *anusam*. *anusaṃbaddha* verbunden mit, begleitet von (im Comp. vorangehend).

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *abhisam* mit Etwas verbinden, so v. a. darunter verstehen. Pass. verbunden werden mit, so v. a. gehören zu (Instr.). *pratyekam* zu Jedem gehören, — zu ergänzen sein [225,22](https://sanskrit-lexicon-scans.github.io/bchrest2/index.html?225). [234,29](https://sanskrit-lexicon-scans.github.io/bchrest2/index.html?234).

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *upasam*, *uapasaṃddha* darangebunden.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *pratisam*, *pratisaṃbaddha* zusammenhängend, in Zusammenhang stehend [CARAKA. 3,8].

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] √*bandh* IV. *bandha* 2te Imper. [R. ed. Bomb. 3,56,21](https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?3,56,21).

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *ā* Med. sich erhängen [R. ed. Bomb. 3,45,36](https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?3,45,36).

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *vini* IV. fesseln [JĀTAKAM. 31]. — Caus. dass. [17,17].
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] bandh [R. ed. Bomb. 3,56,21](https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?3,56,21) bandha 2. Imper.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit ā [Med.] sich erhängen, [R. ed. Bomb. 3,45,36.](https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?3,45,36)

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit vini fesseln, [Jātakam. 31.]

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — [Kaus.] dass.,17,17.
