...
[MBH. 13,7306.](https://sanskrit-lexicon-scans.github.io/mbhcalc?13.7306) = [≈Vulg. 13.156.16](mbh/13.156.html#v16) = ≈krit. 13,141.16a
  — ʰ PWKVN **1.** *śru* VI. *śuśrāva* mit pass. Bed. [R. 7,27,23](https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?7,27,23). — Mit *upa* VI. geloben [JĀTAKAM. 31].
  — ʰ PWKVN **1.** *śru* mit *prati* VI. antworten hinzuzufügen.
...
**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **2.** √*śru* = *sru* sich in Bewegung (namentlich der Theile) setzen, auseinandergehen, zerfliessen. Nur *śruvat* und *śruvanta*. In den späteren Schriften einfach Fehler für *sru*.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *ā* (nur *ā — aśrot*) weichen, nachgeben.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *pra* Caus. (*˚śravayati* und *˚śrāvayati*) vorwärts bringen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *vi* in **2.** *viśruti*.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] — Mit *sam*, *saṃśruta* zusammengeflossen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **1.** √*śru* VI. *śuśrāva* mit pass. Bed. [R. 7,27,23](https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?7,27,23).
— Mit *upa* VI. geloben [JĀTAKAM. 31].

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] **1.** √*śru* mit *prati* VI. antworten hinzuzufügen.

**+)** [neue Bedeutung, in PWG ohne Entsprechung — цель не указана] 1. [śru] , śuśrāva mit pass. Bed., [R. 7,27,23.](https://sanskrit-lexicon-scans.github.io/ramayanabom/app1/?7,27,23) — Mit upa geloben, [Jātakam. 31.] — Mit prati "antworten" hinzuzufügen. {part=,seq=25726,type=,n=4}
