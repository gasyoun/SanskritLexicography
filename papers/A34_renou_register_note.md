...
> Then the author-voice pass 06-09-2026 ([SIGNOFF_A34_author_pass.md](https://github.com/gasyoun/SanskritLexicography/blob/master/papers/SIGNOFF_A34_author_pass.md)), voice and framing only.
...
tag cannot express either. I operationalise both axes, a diachronic state axis
...
both the corpus and the period axis structurally miss. I release the tagger and eight
register glossaries.
...
I am not aware of a prior operationalisation of Renou's *subsections* — as opposed to
his five chapter-states — as a tagging scheme.

## 2. Method

I tag every dictionary sense on two independent axes, each multi-label (a word can
...
and well attested across dictionaries: *bhāṣya* tags 14,498 distinct headwords (10,320 attested in ≥2
...
than a flat label. Two concrete payoffs: (1) reusable register lexica: I ship eight
