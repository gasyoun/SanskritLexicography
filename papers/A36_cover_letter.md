...
Angelika Rüter / Nodus Publikationen (Münster)
...
(Böhtlingk–Roth) and their successors glossed taboo headwords not in the vernacular but in
...
in Böhtlingk–Roth (1855–75), tightening *within Monier-Williams's own two editions*
(*futuere* nil in 1872, four times in 1899), fading by Schmidt's *Nachträge* (1928), and
absent from the dictionaries written for Indian readers (both Apte editions gloss √*yabh*
openly as "to cohabit"). A controlled comparison is afforded by Carl Cappeller, who screened
in *both* his Sanskrit–German (1887) and his Sanskrit–English (1891) dictionary. Second, as
**method**: detecting such a screen computationally is confounded because the screen-language,
Latin, is also the source of the target language's ordinary technical vocabulary (English
*semen, penis, coitus* are simply English). The paper offers a *metalanguage-relative* test
that resolves the confound, validated across the full 43-dictionary Cologne Digital Sanskrit
Dictionaries corpus and against three internal controls — a result I believe transfers to any
tradition whose discretion-screen is written in a prestige language (Latin or Greek into the
...
length, apparatus, and citation style to the journal's house conventions, and — should the
editors prefer — to provide the article in German.
