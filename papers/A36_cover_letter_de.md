...
An die Herausgeberinnen der
*Beiträge zur Geschichte der Sprachwissenschaft*
Frau Prof. Dr. Gerda Haßler (Universität Potsdam)
Frau Angelika Rüter / Nodus Publikationen (Münster)
...
die Petersburger Schule (Böhtlingk–Roth) und ihre Nachfolger anstößige Stichwörter nicht in
...
Böhtlingk–Roth (1855–1875), sich verschärfend innerhalb der beiden Auflagen von
Monier-Williams (*futuere* 1872 nicht belegt, 1899 viermal), abklingend bei Schmidts
*Nachträgen* (1928) und fehlend in den für indische Leser bestimmten Wörterbüchern (beide
Auflagen von Apte glossieren √*yabh* offen mit „to cohabit"). Eine kontrollierte Gegenprobe
bietet Carl Cappeller, der sowohl in seinem Sanskrit-deutschen (1887) als auch in seinem
Sanskrit-englischen Wörterbuch (1891) verschleiert. Zweitens als **Methode**: Die
rechnergestützte Erkennung eines solchen Schirms wird dadurch erschwert, dass die
Schirmsprache – das Lateinische – zugleich die Quelle des fachsprachlichen Wortschatzes der
Zielsprache ist (englisch *semen, penis, coitus* sind schlicht englische Wörter). Der
Aufsatz schlägt einen **metasprachenrelativen** Test vor, der dieses Problem löst und an
allen 43 Wörterbüchern des Korpus der *Cologne Digital Sanskrit Dictionaries* sowie an drei
internen Kontrollen validiert wird – ein Ergebnis, das sich m. E. auf jede Tradition
übertragen lässt, deren Diskretionsschirm in einer Prestigesprache abgefasst ist (Latein
...
ist original, wird nicht andernorts zur Veröffentlichung erwogen, und es bestehen keine
Interessenkonflikte. Gern passe ich Umfang, Apparat und Zitierweise den Gepflogenheiten der
Zeitschrift an; eine deutsche Fassung des Aufsatzes selbst stelle ich auf Wunsch bereit.
