...
| [§92](https://github.com/gasyoun/SanskritLexicography/blob/master/FINDINGS.md) | **A** | A · self (see Source) | — | A verified claim register is not Whitney-proof — 3 of 229 verdict_fact: TRUE rows in Kochergina claims.yml contradict Wh |
