...
| 4 | Morphology databanks | Current inflected-form XML banks → forms oracle for SanskritSpellCheck + third witness beside kosha's vidyut-built forms layer (426,410 pairs) — diff, never overwrite | SanskritSpellCheck, kosha | ~~Phase 0 @DO download; @DECIDE for anything vendored~~ **both cleared 03-07-2026** | 🟢 **Fully unblocked 03-07-2026** — data downloaded+verified (1,286,615 forms / 32,837 stems, v3.81 2026-06-21), staged at `HeadwordLists/heritage_mirror/manual/` (gitignored); license @DECIDE resolved (Huet approved, see §2 above). See [FINDINGS §51 update](https://github.com/gasyoun/SanskritLexicography/blob/master/FINDINGS.md). **Build not started** — needs its own H### |
| 5 | Heritage dictionary (DICO) | French gloss layer + entry structure as an additional witness/gloss source for kosha entries | kosha | ~~@DECIDE ruling + Huet outreach reply~~ **both cleared 03-07-2026** | 🟢 **Unblocked 03-07-2026** — Huet approved the license composition; DICO data already in the local mirror ([HeadwordLists/heritage_mirror/DICO/](HeadwordLists/HERITAGE_MIRROR_INVENTORY.md)). **Build not started** — needs its own H### |
