...
_Created: 03-07-2026 · Last updated: 03-07-2026 (Phase 4 forms-oracle delivered — H105)_
...
Phases 1–4 are done (1–3 off the mirror; 4 off the human-downloaded morphology XML);
Phase 5 (DICO gloss layer, H106) is unblocked and queued; 6 can run whenever a session
needs the second morphology witness.
