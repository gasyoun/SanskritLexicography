...
_Created: 26-06-2026 · Last updated: 14-08-2026 (§532 — DeepSeek-v4-flash reference-free QE on a 80-row slice of frozen grade_gold reaches Spearman ρ=0.4195 and is defensible; proxy remains ρ=-0.0351 preliminary and is not comet; §531 — *ārṣa prayoga* is a one-way licence)_
...
(currently §533) whatever its section, so existing numbers never shift; when a finding is later
