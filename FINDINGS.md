...
### §611 — the window audit's "units clean" line is NOT the promotable verdict, and `promote_final_cards.py --merge` is not dry-run by default (29-08-2026, H3663)
