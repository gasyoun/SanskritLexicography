...
### §611. A planner that feeds production must pass the SAME binding as the coordinator — `no_pwg_scale_plan` stamped a v1 manifest production refuses, so every lease it prepared was unrunnable
...
> (Opus 5 `claude-opus-5`) · closes gate 3 of §602 / §604. — SanskritLexicography · 2026-08-29
