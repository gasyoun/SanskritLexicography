...
_Created: 02-08-2026 · Last updated: 01-09-2026_
...
>
> **Drain-confirm 01-09-2026** (Sonnet 5 `claude-sonnet-5`, [H3796](https://github.com/gasyoun/Uprava/blob/main/handoffs/H3796-Sonnet_SanskritLexicography_progress-kitchen-improvements-drain_31.08.26.md)). §7's residual queue was still tabled as a partly-open worklist even though every row — all 12 K/B units plus all 6 Grok dual-run compares — closed ✅ in the registry between 03-08 and 06-08-2026; no `progress_dashboard/` code has landed since besides the truth-pass banner commit above. §7 rewritten to state that, `ROADMAP_INDEX.md`'s index cell bumped to this date. Reporting mechanics re-verified, not rebuilt: the 7 `progress_dashboard/*_selftest.py` gates all exit 0 read directly (not through a pipe); no dashboard artefact was regenerated this pass, so no removal-diff was needed.
...
## 7. Residual Grok queue (minted 03-08-2026) — **fully drained 01-09-2026**

K1–K8 UI is shipped (H2212). All 12 measurement-gap residuals below, plus every one of their Grok 4.5 dual-run compares, closed ✅ in the [Uprava registry](https://github.com/gasyoun/Uprava/blob/main/handoffs/REGISTRY_ARCHIVE.md) between 03-08 and 06-08-2026 (H2255/H2258/H2260/H2262/H2268/H2275 compares confirmed each; no re-opens since). No starter line remains — there is nothing left to run in this queue.

| Order | ID | Effort | Title / gap — status |
|---|---|---|---|
| 1 | [H2230](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2230-Grok_SanskritLexicography_progress-kitchen-wallclock-token-dense_03.08.26.md) | hard | Dense wall-clock + tokens (B2 / K6 residual) — ✅ done (Sonnet override [#1080](https://github.com/gasyoun/SanskritLexicography/pull/1080) + Grok dual-run [H2255](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2255-Grok_SanskritLexicography_h2230-grok-dual-run-compare_03.08.26.md)): append_ledger dense stamp + backfill already shipped (H2212/H2218); real gap was blended coverage — post_cut/historical split on `wall_clock_source`; Grok residual added selftest pin + post_cut token UI honesty ([compare](https://github.com/gasyoun/SanskritLexicography/blob/master/progress_dashboard/H2255_H2230_DUAL_RUN_COMPARE_2026-08-06.md)) |
| 2 | [H2231](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2231-Grok_SanskritLexicography_progress-kitchen-gen-model-host-profile_03.08.26.md) | medium | gen_model / host / profile (B8) — ✅ done: `resolve_gen_model`/`resolve_host`/`resolve_profile` + always-stamp on `append_ledger`; kitchen `multi_lane` aggregate + Multi-lane mix panel; pinned by `window_selftest.test_ledger_stamps_host_profile_b8` + `kitchen_multi_lane_selftest.py` |
| 3 | [H2232](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2232-Grok_SanskritLexicography_progress-kitchen-true-cost-subscription_03.08.26.md) | medium | True $ / subscription units (B1) — ✅ done 03-08-2026 (Sonnet 5): verified duplicate of H2218's B1 loader/UI/cost_honesty; only remaining step is a human pasting a real weekly usage export ([#1040](https://github.com/gasyoun/SanskritLexicography/pull/1040) merged) |
| 4 | [H2233](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2233-Grok_SanskritLexicography_progress-kitchen-verb-eta-roots-per-day_03.08.26.md) | medium | Verb ETA roots/day (K4 residual) — ✅ done 03-08-2026 (Sonnet 5 override, Grok dual-run [H2258](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2258-Grok_SanskritLexicography_h2233-dual-run-compare_03.08.26.md) confirmed identical, 8.0 roots/day → 87.6d ETA; [#1085](https://github.com/gasyoun/SanskritLexicography/pull/1085), [#1159](https://github.com/gasyoun/SanskritLexicography/pull/1159) merged) |
| 5 | [H2234](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2234-Grok_SanskritLexicography_progress-kitchen-idle-reason-tags_03.08.26.md) | medium | Idle reason tags (B9) — ✅ done 03-08-2026 (Sonnet 5 override): already fully shipped by H2218/[#1041](https://github.com/gasyoun/SanskritLexicography/pull/1041); Grok dual-run [H2256](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2256-Grok_SanskritLexicography_h2234-grok-dual-run-compare_03.08.26.md) CONFIRMED no code change needed |
| 6 | [H2235](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2235-Grok_SanskritLexicography_progress-kitchen-review-throughput-series_03.08.26.md) | medium | Review throughput series (B5) — ✅ done 03-08-2026 (Sonnet 5 override, Grok dual-run [H2260](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2260-Grok_SanskritLexicography_h2235-sonnet-dual-run-compare_03.08.26.md)); [#1092](https://github.com/gasyoun/SanskritLexicography/pull/1092), [#1162](https://github.com/gasyoun/SanskritLexicography/pull/1162) merged |
| 7 | [H2236](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2236-Grok_SanskritLexicography_progress-kitchen-quality-timeseries_03.08.26.md) | hard | Quality timeseries (B4) — ✅ done 03-08-2026 (Sonnet 5 override, Grok dual-run [H2262](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2262-Grok_SanskritLexicography_h2236-dual-run-compare_03.08.26.md) confirmed equivalent); [#1096](https://github.com/gasyoun/SanskritLexicography/pull/1096) merged |
| 8 | [H2237](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2237-Grok_SanskritLexicography_progress-kitchen-promote-vs-generate_03.08.26.md) | medium | Promote vs generate (B6) — ✅ done (Grok dual-run [H2265](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2265-Grok_SanskritLexicography_h2237-dual-run-compare_03.08.26.md), [#1160](https://github.com/gasyoun/SanskritLexicography/pull/1160) merged) |
| 9 | [H2238](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2238-Grok_SanskritLexicography_progress-kitchen-nominal-burn-down_03.08.26.md) | medium | Nominal burn-down (B7) — ✅ done 04-08-2026 (Sonnet 5 override, Grok dual-run [H2275](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2275-Grok_SanskritLexicography_h2238-dual-run-compare_04.08.26.md) kept the burn-down + live 2/50); [#1119](https://github.com/gasyoun/SanskritLexicography/pull/1119), [#1167](https://github.com/gasyoun/SanskritLexicography/pull/1167), [#1168](https://github.com/gasyoun/SanskritLexicography/pull/1168) merged |
| 10 | [H2239](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2239-Grok_SanskritLexicography_progress-kitchen-article-parity_03.08.26.md) | medium | Article-site parity (B10) — ✅ done (duplicate of H2218; Sonnet override no-op + Grok dual-run [H2267](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2267-Grok_SanskritLexicography_h2239-dual-run-compare_04.08.26.md)): kitchen already had `article_site_parity` + `article_parity` JSON + UI card; honest `measured:false` when site absent ([compare](https://github.com/gasyoun/SanskritLexicography/blob/master/progress_dashboard/H2267_H2239_DUAL_RUN_COMPARE_2026-08-06.md)) |
| 11 | [H2240](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2240-Grok_SanskritLexicography_progress-kitchen-health-probe-log_03.08.26.md) | medium | Canonical health_probe_log (B3 residual) — ✅ done (override dual-run, Sonnet 5 + Grok H2269 residual): dual-write + exclusive reader prefer (Sonnet #1120); H2269 fixed `_emit` so the canonical log is written even when `events_path is None`, added `source_mode`, README path, migrate `--output-dir`, 4/4 selftest — [H2269_H2240_DUAL_RUN_COMPARE_2026-08-06.md](https://github.com/gasyoun/SanskritLexicography/blob/master/progress_dashboard/H2269_H2240_DUAL_RUN_COMPARE_2026-08-06.md) |
| 12 | [H2241](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2241-Grok_SanskritLexicography_progress-kitchen-timeseries-slices_03.08.26.md) | medium | Kitchen slices in progress_timeseries — ✅ done 04-08-2026 (Sonnet 5 override, Grok dual-run [H2268](https://github.com/gasyoun/Uprava/blob/main/handoffs/archive/H2268-Grok_SanskritLexicography_h2241-dual-run-compare_04.08.26.md)); [#1112](https://github.com/gasyoun/SanskritLexicography/pull/1112), [#1163](https://github.com/gasyoun/SanskritLexicography/pull/1163) merged |

No open unit remains in this queue. Any *future* kitchen-improvement work is a fresh handoff against a fresh gap in §§2–4 above, not a re-run of anything in this table.
