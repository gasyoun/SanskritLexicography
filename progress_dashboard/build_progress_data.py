...
def nominal_lane():
    ...
    # medium-50 band (H317 → H437): live-measured via shared helper so progress
    # and kitchen surfaces cannot drift (H2275 dual-run residual). Pause reason
    # is the full structured object (incl. detail) — B7 acceptance.
