...
_Created: 08-07-2026 · Last updated: 27-07-2026_ (H702 cheap-test sweep: §1–§4 re-verified with full local evidence — the §4 re-tally corrected the recorded no-PWG count ≈35,900→61,906 and §3 got a full-749-root census; §5–§7 annotated with concrete test costs; Fable 5 `claude-fable-5`, two passes)
...
### §3. A lemma's declension class can be read off its citation form
