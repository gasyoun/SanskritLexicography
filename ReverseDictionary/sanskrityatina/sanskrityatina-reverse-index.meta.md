...
_Revision history v4 (19-09-2026):_ backlog item 2 resolved by H4800 — full per-headword stock recovered from `reverse-index-full.doc`, joined to union-16, registered in kosha as `sanskrityatina-reverse-vs-union16`.
