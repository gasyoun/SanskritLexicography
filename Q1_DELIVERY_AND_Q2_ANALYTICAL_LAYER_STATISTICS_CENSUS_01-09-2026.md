...
|---|---|---|---|
| **§10** | Union headwords **323,422** vs 323,422 | ✅ **RULED 26-08-2026** (H3538, Tier 1) — both true under different scopes; line 1 of `union_headwords.tsv` is a column header, so data rows = 323,422. **The headword count of record is 323,422.** | Do not cite kosha-side prose that still reads 323,422 as a headword count. The residual is a kosha `[integrity]` wording fix, not a re-measurement. |
