...
Это **тонкий индекс**: канонический набор руководств — четыре аудиторных и
четыре глубоких манускрипта в
[docs/manuals/](https://github.com/gasyoun/SanskritLexicography/tree/master/docs/manuals)
(плюс этот лист и агентский близнец в корне; маршрутизатор
[docs/manuals/README.md](https://github.com/gasyoun/SanskritLexicography/blob/master/docs/manuals/README.md)
перечисляет все десять);
...
и квота сейчас не является узким местом. Цепочка H442/H462 закрыта (см. §3);
узкое место — live-gate / среда, не число аккаунтов. Что 4 аккаунта дают уже
